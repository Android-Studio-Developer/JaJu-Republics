...
var l = o((e => {
  ...
  , h = o((e => {
    ...
    var h = Object.assign
      ...
      , j = Symbol.iterator;
    function ee(e) {
        return typeof e != `object` || !e ? null : (e = j && e[j] || e[`@@iterator`],
        typeof e == `function` ? e : null)
    }
...
` + e.stack
    ...
    var Ot = RegExp(`^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$`)
      ...
      , At = {};
    function jt(e) {
        return we.call(At, e) ? !0 : we.call(kt, e) ? !1 : Ot.test(e) ? At[e] = !0 : (kt[e] = !0,
        !1)
    }
    function Mt(e, t, n) {
        if (jt(t))
    ...
    function Ut(e, t, n, r, i, a, o, s) {
        ...
        t == null ? n == null ? r != null && e.removeAttribute(`value`) : Gt(e, o, Ft(n)) : Gt(e, o, Ft(t)),
    ...
    function Qt(e, t, n) {
        ...
        n != null) {
            ...
            for (var a in t)
                r = t[a],
                t.hasOwnProperty(a) && n[a] !== r && Zt(e, a, r)
        } else
            for (var o in t)
                t.hasOwnProperty(o) && Zt(e, o, t[o])
    }
    function $t(e) {
        if (e.indexOf(`-`) === -1)
            return !1;
    ...
    function ln(e) {
        ...
        if (t && (e = t.stateNode)) {
            ...
            t.type) {
            case `input`:
                if (Ut(e, n.value, n.defaultValue, n.defaultValue, n.checked, n.defaultChecked, n.type, n.name),
                t = n.name,
                n.type === `radio` && t != null) {
    ...
    function F(e) {
        function t(t, n, r, i, a) {
            ...
            e)
                ...
                this[o] = t ? t(i) : i[o]);
            return this.isDefaultPrevented = (i.defaultPrevented == null ? !1 === i.returnValue : i.defaultPrevented) ? xn : Sn,
    ...
    var Cn = {
        ...
        movementX: function(e) {
            return `movementX`in e ? e.movementX : (e !== On && (On && e.type === `mousemove` ? (Dn = e.screenX - On.screenX,
            I = e.screenY - On.screenY) : I = Dn = 0,
            On = e),
            Dn)
        },
    ...
    var Vn = F(h({}, Tn, {
        key: function(e) {
            ...
            return e.type === `keypress` ? (e = bn(e),
            e === 13 ? `Enter` : String.fromCharCode(e)) : e.type === `keydown` || e.type === `keyup` ? Ln[e.keyCode] || `Unidentified` : ``
        },
        code: 0,
        location: 0,
        ctrlKey: 0,
      ...
      , qn = [9, 13, 27, 32]
      , Jn = pn && `CompositionEvent`in window
      , Yn = null;
    pn && `documentMode`in document && (Yn = document.documentMode);
    var Xn = pn && `TextEvent`in window && !Yn
      , Zn = pn && (!Jn || Yn && 8 < Yn && 11 >= Yn)
      , Qn = ` `
      , $n = !1;
    function er(e, t) {
        switch (e) {
    ...
    function ir(e, t) {
        if (nr)
            return e === `compositionend` || !Jn && er(e, t) ? (e = yn(),
            vn = _n = gn = null,
            nr = !1,
            e) : null;
        switch (e) {
    ...
    function _r() {
        cr && (cr.detachEvent(`onpropertychange`, vr),
        lr = cr = null)
    }
    function vr(e) {
    ...
    function yr(e, t, n) {
        ...
        cr = t,
        lr = n,
        cr.attachEvent(`onpropertychange`, vr)) : e === `focusout` && _r()
    }
    function br(e) {
    ...
    var jr = pn && `documentMode`in document && 11 >= document.documentMode
      , Mr = null
      , Nr = null
      , Pr = null
      , Fr = !1;
    function Ir(e, t, n) {
        ...
        Fr || Mr == null || Mr !== Bt(r) || (r = Mr,
        `selectionStart`in r && Ar(r) ? r = {
    ...
    var Rr = {
      ...
      , zr = {}
      , Br = {};
    pn && (Br = document.createElement(`div`).style,
    ...
    function fi(e, t) {
        var n = e.alternate;
        return n === null ? (n = ui(e.tag, t, e.key, e.mode),
    ...
    function mi(e, t, n, r, a, o) {
        ...
        typeof e == `function`)
            ...
            case b:
                ...
                break;
            case x:
                return e = ui(12, n, t, a | 2),
                e.elementType = x,
                e.lanes = o,
                e;
            case T:
                return e = ui(13, n, t, a),
                e.elementType = T,
                e.lanes = o,
                e;
            case E:
                return e = ui(19, n, t, a),
                e.elementType = E,
                e.lanes = o,
                e;
            default:
    ...
    function vi(e, t, n) {
        return t = ui(4, e.children === null ? [] : e.children, e.key, t),
        t.lanes = n,
        t.stateNode = {
    ...
    var Fi = null
      ...
      , Ri = Error(i(519));
    function zi(e) {
        throw Wi(bi(Error(i(418, 1 < arguments.length && arguments[1] !== void 0 && arguments[1] ? `text` : `HTML`, ``)), e)),
        Ri
    }
    function Bi(e) {
        var t = e.stateNode
        ...
        case `textarea`:
            Q(`invalid`, t),
            Jt(t, r.value, r.defaultValue, r.children)
        }
        n = r.children,
    ...
    function Vi(e) {
        ...
        t === 13) {
            ...
            Zd(e.type) ? (e = lf,
            lf = null,
            L = e) : L = t) : L = Fi ? cf(e.stateNode.nextSibling) : null;
        return !0
    }
    function Hi() {
        L = Fi = null,
    ...
    var Gi = se(null)
      ...
      , qi = null;
    function Ji(e, t, n) {
        P(Gi, t._currentValue),
        t._currentValue = n
    }
    function Yi(e) {
        e._currentValue = Gi.current,
        ce(Gi)
    }
    function Xi(e, t, n) {
        for (; e !== null; ) {
    ...
    function Qi(e) {
        for (e = e.firstContext; e !== null; ) {
            if (!wr(e.context._currentValue, e.memoizedValue))
                return !0;
            e = e.next
        }
        return !1
    ...
    function Ea(e, t, n) {
        switch (n = e[n],
        n === void 0 ? e.push(t) : n !== t && (t.then(rn, rn),
        t = n),
        t.status) {
        case `fulfilled`:
            return t.value;
    ...
    function Da(e) {
        try {
            ...
            throw typeof e == `object` && e && typeof e.then == `function` ? (Oa = e,
            xa) : e
        }
    }
    var Oa = null;
    ...
    function Ia(e) {
        ...
        function l(e, t, n, r) {
            var i = n.type;
            return i === y ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == `object` && i && i.$$typeof === O && Da(i) === t.type) ? (t = a(t, n.props),
            Pa(t, n),
            t.return = e,
        ...
        function m(e, t, n, r, i) {
            ...
            if (typeof r == `object` && r) {
                ...
                if (typeof r.then == `function`)
                    return m(e, t, n, Na(r), i);
                if (r.$$typeof === C)
                    return m(e, t, n, ta(t, r), i);
                Fa(t, r)
            }
            return null
        }
    ...
    function To() {
        var e = M.H
          , t = e.useState()[0];
        return t = typeof t.then == `function` ? Ao(t) : t,
        e = e.useState()[0],
    ...
    function os(e, t, n, r) {
        ...
        U !== null && r !== null && xo(r, U.memoizedState.deps) ? i.memoizedState = rs(t, a, n, r) : (H.flags |= e,
        i.memoizedState = rs(1 | t, a, n, r))
    }
    function ss(e, t) {
        as(8390656, 8, e, t)
    }
    ...
    function ys(e, t, n, r) {
        return wr(n, t) ? n : Za.current === null ? !(uo & 42) || uo & 1073741824 && !(Y & 261930) ? (tc = !0,
    ...
    function bs(e, t, n, r, i) {
        ...
        try {
            var c = i()
              , l = M.S;
            l !== null && l(s, c),
            typeof c == `object` && c && typeof c.then == `function` ? js(e, t, ha(c, r), pu(e)) : js(e, t, r, pu(e))
        } catch (n) {
            js(e, t, {
                then: function() {},
                status: `rejected`,
    ...
    function Ss(e, t, n, r) {
        if (e.tag !== 5)
            throw Error(i(476));
        var a = Cs(e).queue;
        bs(e, a, t, ie, n === null ? xs : function() {
            return ws(e),
            n(r)
        }
        )
    ...
    var Ls = {
        ...
        useCallback: function(e, t) {
            return G().memoizedState = [e, t === void 0 ? null : t],
            e
        },
        useContext: ea,
        useEffect: ss,
        ...
        useTransition: function() {
            var e = Uo(!1);
            return e = bs.bind(null, H, e.queue, !0, !1),
            G().memoizedState = e,
            [!1, e]
        },
        ...
        useOptimistic: function(e) {
            ...
            return t.queue = n,
            t = Ms.bind(null, H, !0, n),
            n.dispatch = t,
            [e, t]
        },
        useMemoCache: Mo,
        useCacheRefresh: function() {
            return G().memoizedState = Os.bind(null, H)
        },
      ...
      , Rs = {
        ...
        useDebugValue: hs,
        useDeferredValue: function(e, t) {
            return ys(Oo(), U.memoizedState, e, t)
        },
        useTransition: function() {
            var e = Po(No)[0]
              , t = Oo().memoizedState;
    ...
    var zs = {
        ...
        useDeferredValue: function(e, t) {
            var n = Oo();
            return U === null ? vs(n, e, t) : ys(n, U.memoizedState, e, t)
        },
        useTransition: function() {
            var e = Io(No)[0]
              , t = Oo().memoizedState;
    ...
    function Hs(e, t, n, r, i, a, o) {
        ...
        typeof e.shouldComponentUpdate == `function` ? e.shouldComponentUpdate(r, a, o) : t.prototype && t.prototype.isPureReactComponent ? !Tr(n, r) || !Tr(i, a) : !0
    }
    function Us(e, t, n, r) {
        e = t.state,
        ...
        typeof r == `object` && r && typeof r.then == `function`) {
            ...
            n !== null) {
                ...
                case 13:
                    ...
                    n.flags |= 65536,
                    n.lanes = a,
                    r === wa ? n.flags |= 16384 : (t = n.updateQueue,
    ...
    function ic(e, t, n, r, i) {
        if (e === null) {
            var a = n.type;
            return typeof a == `function` && !di(a) && a.defaultProps === void 0 && n.compare === null ? (t.tag = 15,
            t.type = a,
            ac(e, t, a, r, i)) : (e = mi(n.type, null, r, t, t.mode, i),
            e.ref = t.ref,
            e.return = t,
            t.child = e)
        }
    ...
    function oc(e, t, n, r) {
        ...
        r.mode === `hidden`) {
            ...
            a === null ? (e !== null && ya(t, null),
            eo(),
            so(t)) : (ya(t, a.cachePool),
            $a(t, a),
            so(t),
            t.memoizedState = null);
        return nc(e, t, i, n),
    ...
    function hc(e, t, n, r, i) {
        ...
        t.stateNode === null) {
            ...
            Ba(t),
            o = n.contextType,
            a.context = typeof o == `object` && o ? ea(o) : ci,
            a.state = t.memoizedState,
            o = n.getDerivedStateFromProps,
            typeof o == `function` && (Bs(t, n, o, r),
            a.state = t.memoizedState),
            ...
            var l = a.context
              , u = n.contextType;
            o = ci,
            typeof u == `object` && u && (o = ea(u));
            var d = n.getDerivedStateFromProps;
            u = typeof d == `function` || typeof a.getSnapshotBeforeUpdate == `function`,
            s = t.pendingProps !== s,
            u || typeof a.UNSAFE_componentWillReceiveProps != `function` && typeof a.componentWillReceiveProps != `function` || (s || l !== o) && Us(t, a, r, o),
            za = !1;
            ...
            qa(),
            l = t.memoizedState,
            s || f !== l || za ? (typeof d == `function` && (Bs(t, n, d, r),
            l = t.memoizedState),
            (c = za || Hs(t, n, c, r, f, l, o)) ? (u || typeof a.UNSAFE_componentWillMount != `function` && typeof a.componentWillMount != `function` || (typeof a.componentWillMount == `function` && a.componentWillMount(),
            typeof a.UNSAFE_componentWillMount == `function` && a.UNSAFE_componentWillMount()),
            ...
            (l = typeof s == `function` || typeof a.getSnapshotBeforeUpdate == `function`) || typeof a.UNSAFE_componentWillReceiveProps != `function` && typeof a.componentWillReceiveProps != `function` || (o !== d || f !== c) && Us(t, a, r, c),
            za = !1,
            f = t.memoizedState,
            a.state = f,
            Ja(t, r, a, i),
            ...
            o !== d || f !== p || za || e !== null && e.dependencies !== null && Qi(e.dependencies) ? (typeof s == `function` && (Bs(t, n, s, r),
            p = t.memoizedState),
            (u = za || Hs(t, n, u, r, f, p, c) || e !== null && e.dependencies !== null && Qi(e.dependencies)) ? (l || typeof a.UNSAFE_componentWillUpdate != `function` && typeof a.componentWillUpdate != `function` || (typeof a.componentWillUpdate == `function` && a.componentWillUpdate(r, p, c),
        ...
        t.flags |= 1,
        e !== null && r ? (t.child = La(t, e.child, null, i),
        t.child = La(t, null, n, i)) : nc(e, t, n, i),
        t.memoizedState = a.state,
        e = t.child) : e = Dc(e, t, i),
        e
    }
    function gc(e, t, n, r) {
        return Hi(),
    ...
    function bc(e, t, n) {
        ...
        if ((s = o) || (s = e !== null && e.memoizedState === null ? !1 : (V.current & 2) != 0),
        s && (a = !0,
        t.flags &= -129),
        s = (t.flags & 32) != 0,
        t.flags &= -33,
        ...
        c !== null)) {
            if (o)
                t.flags & 256 ? (io(t),
                t.flags &= -257,
                t = Cc(e, t, n)) : t.memoizedState === null ? (so(t),
                c = r.fallback,
                a = t.mode,
                r = Sc({
                    mode: `visible`,
        ...
        c === null ? c = vc(n) : (a = c.cachePool,
        a === null ? a = ba() : (l = oa._currentValue,
        a = a.parent === l ? a : {
            parent: l,
            pool: l
        }),
    ...
    function kc(e, t, n) {
        ...
        case 13:
            ...
            if (r !== null)
                ...
                e = Dc(e, t, n),
                e === null ? null : e.sibling) : bc(e, t, n) : (io(t),
                t.flags |= 128,
                null);
            io(t);
            break;
    ...
    function Ac(e, t, n) {
        if (e !== null)
            ...
            tc = !1,
            R && t.flags & 1048576 && ji(t, wi, t.index);
        switch (t.lanes = 0,
        t.tag) {
        case 16:
            a: {
                var r = t.pendingProps;
                if (e = Da(t.elementType),
                t.type = e,
                typeof e == `function`)
                    di(e) ? (r = Ws(e, r),
                    t.tag = 1,
                    t = hc(null, t, e, r, n)) : (t.tag = 0,
                    t = pc(null, t, e, r, n));
                else {
                    if (e != null) {
                        var a = e.$$typeof;
        ...
        case 3:
            a: {
                if (pe(t, t.stateNode.containerInfo),
                e === null)
                    throw Error(i(387));
                r = t.pendingProps;
        ...
        case 27:
            return he(t),
            e === null && R && (r = t.stateNode = ff(t.type, t.pendingProps, de.current),
            Fi = t,
            Li = !0,
            a = L,
            Zd(t.type) ? (lf = a,
        ...
        case 5:
            ...
            t.memoizedState !== null && (a = So(e, t, To, null, null, n),
            Qf._currentValue = a),
            fc(e, t),
            nc(e, t, r, n),
            t.child;
        ...
        case 13:
            return bc(e, t, n);
        case 4:
            return pe(t, t.stateNode.containerInfo),
            r = t.pendingProps,
            e === null ? t.child = La(t, null, r, n) : nc(e, t, r, n),
            t.child;
        case 11:
            return rc(e, t, t.type, t.pendingProps, n);
        case 7:
            return nc(e, t, t.pendingProps, n),
            t.child;
        case 8:
            return nc(e, t, t.pendingProps.children, n),
            t.child;
        case 12:
            return nc(e, t, t.pendingProps.children, n),
            t.child;
    ...
    function Lc(e, t, n) {
        ...
        case 3:
            ...
            (e === null || e.child === null) && (Vi(t) ? jc(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024,
            Ui())),
            Ic(t),
            null;
        case 26:
            ...
            return e === null ? (jc(t),
            o === null ? (Ic(t),
            Mc(t, a, null, r, n)) : (Ic(t),
            Nc(t, o))) : o ? o === e.memoizedState ? (Ic(t),
            t.flags &= -16777217) : (jc(t),
            Ic(t),
            Nc(t, o)) : (e = e.memoizedProps,
            e !== r && jc(t),
            Ic(t),
            Mc(t, a, e, r, n)),
            null;
            ...
            o === null)
                        ...
                        for (e = t.child; e !== null; ) {
                            ...
                            o !== null) {
                                ...
                                n = t.child; n !== null; )
                                    pi(n, e),
                                    n = n.sibling;
                                return P(V, V.current & 1 | 2),
                                R && Ai(t, r.treeForkCount),
                                t.child
                            }
                            e = e.sibling
                        }
                    r.tail !== null && ke() > tu && (t.flags |= 128,
                    a = !0,
                    Fc(r, !1),
                    t.lanes = 4194304)
                }
                ...
                if (!a)
                    ...
                    e !== null) {
                        ...
                        2 * ke() - r.renderingStartTime > tu && n !== 536870912 && (t.flags |= 128,
                        a = !0,
                        Fc(r, !1),
                        t.lanes = 4194304);
        ...
        case 23:
            ...
            r ? n & 536870912 && !(t.flags & 128) && (Ic(t),
            t.subtreeFlags & 6 && (t.flags |= 8192)) : Ic(t),
            n = t.updateQueue,
    ...
    function Uc(e, t, n) {
        n.props = Ws(e.type, e.memoizedProps),
    ...
    function _l(e, t) {
        ...
        case 13:
            hl(t, e),
            vl(e),
            e.child.flags & 8192 && e.memoizedState !== null != (n !== null && n.memoizedState !== null) && ($l = ke()),
            r & 4 && (r = e.updateQueue,
            r !== null && (e.updateQueue = null,
            ml(e, r)));
            break;
    ...
    var Ll = {
      ...
      , fu = null;
    function pu() {
        return K & 2 && Y !== 0 ? Y & -Y : M.T === null ? st() : dd()
    }
    function mu() {
        if (Jl === 0)
            if (!(Y & 536870912) || R) {
    ...
    function Cu(e, t) {
        ...
        t === xa || t === Ca ? (t = ka(),
        X = 3) : t === Sa ? (t = ka(),
        X = 4) : X = t === ec ? 8 : typeof t == `object` && t && typeof t.then == `function` ? 6 : 1,
        zl = t,
        J === null && (Wl = 1,
        Js(e, bi(t, e.current)))
    }
    ...
    function Ku(e, t, n) {
        ...
        e.warmLanes &= ~n,
        q === e && (Y & n) === n && (Wl === 4 || Wl === 3 && (Y & 62914560) === Y && 300 > ke() - $l ? !(K & 2) && Su(e, 0) : ql |= n,
        Yl === Y && (Yl = 0)),
        rd(e)
    }
    function qu(e, t) {
    ...
    function Cd(e, t, n, r) {
        ...
        n = i.bind(null, t, n, e),
        i = void 0,
        !mn || t !== `touchstart` && t !== `touchmove` && t !== `wheel` || (i = !0),
        ...
        dn(function() {
            ...
            a: {
                ...
                if (c !== void 0) {
                    ...
                    for (var m = r, h; m !== null; ) {
                        ...
                        if (h = g.stateNode,
                        g = g.tag,
                        g !== 5 && g !== 26 && g !== 27 || h === null || p === null || (g = fn(m, p),
            ...
            if (!(t & 7)) {
                a: {
                    ...
                    c && n !== an && (u = n.relatedTarget || n.fromElement) && (yt(u) || u[ft]))
                        break a;
                    ...
                    l !== u)) {
                        ...
                        p = `onMouseEnter`,
                        m = `mouse`,
                        (e === `pointerout` || e === `pointerover`) && (d = Hn,
                        g = `onPointerLeave`,
                        p = `onPointerEnter`,
                        m = `pointer`),
                        f = l == null ? c : xt(l),
                ...
                a: {
                    ...
                    l === `select` || l === `input` && c.type === `file`)
                        ...
                        l = c.nodeName,
                        !l || l.toLowerCase() !== `input` || c.type !== `checkbox` && c.type !== `radio` ? r && $t(r.elementType) && (v = fr) : v = xr;
                    if (v &&= v(e, r)) {
                        sr(s, v, n, i);
                        break a
                    }
                    y && y(e, c, r),
                    e === `focusout` && r && c.type === `number` && r.memoizedProps.value != null && Gt(c, `number`, c.value)
                }
                switch (y = r ? xt(r) : window,
                e) {
                case `focusin`:
                    (or(y) || y.contentEditable === `true`) && (Mr = y,
                    Nr = r,
                    Pr = null);
                    break;
                case `focusout`:
                ...
                if (Jn)
                    ...
                    nr ? er(e, n) && (x = `onCompositionEnd`) : e === `keydown` && n.keyCode === 229 && (x = `onCompositionStart`);
                x && (Zn && n.locale !== `ko` && (nr || x !== `onCompositionStart` ? x === `onCompositionEnd` && nr && (b = yn()) : (gn = i,
                _n = `value`in gn ? gn.value : gn.textContent,
                nr = !0)),
                y = Ed(r, x),
                0 < y.length && (x = new Fn(x,e,null,n,i),
                s.push({
                    event: x,
                    listeners: y
                }),
                b ? x.data = b : (b = tr(n),
                b !== null && (x.data = b)))),
                (b = Xn ? rr(e, n) : ir(e, n)) && (x = Ed(r, `onBeforeInput`),
                0 < x.length && (y = new Fn(`onBeforeInput`,`beforeinput`,null,n,i),
                s.push({
                    event: y,
                    listeners: x
                }),
    ...
    function Od(e, t, n, r, i) {
        for (var a = t._reactName, o = []; n !== null && n !== r; ) {
            ...
            i ? (l = fn(n, a),
            l != null && o.unshift(Td(n, l, c))) : i || (l = fn(n, a),
...
`).replace(Ad, ``)
    ...
    function $(e, t, n, r, a, o) {
        ...
        case `textContent`:
            break;
        default:
            (!(2 < n.length) || n[0] !== `o` && n[0] !== `O` || n[1] !== `n` && n[1] !== `N`) && (n = en.get(n) || n,
            Mt(e, n, r))
        }
    }
    ...
    function Fd(e, t, n, r) {
        ...
        case `select`:
            ...
            n = s,
            r = m,
            p == null ? !!r != !!n && (t == null ? Kt(e, !!n, n ? [] : ``, !1) : Kt(e, !!n, t, !0)) : Kt(e, !!n, p, !1);
            return;
        case `textarea`:
            for (c in m = p = null,
            n)
    ...
    function wf(e, t, n) {
        ...
        if (r && e && t) {
            ...
            t === `image` && n && n.imageSrcSet ? (i += `[imagesrcset="` + Ht(n.imageSrcSet) + `"]`,
            typeof n.imageSizes == `string` && (i += `[imagesizes="` + Ht(n.imageSizes) + `"]`)) : i += `[href="` + Ht(e) + `"]`;
            var a = i;
            switch (t) {
            case `style`:
                a = Af(e);
  ...
  , b = c(g())
  , x = v()
  , S = [[`home`, `Home`], [`about`, `About Us`], [`geography`, `Geography`], [`government`, `Government`], [`economy`, `Economy`]];
function C({activeSection: e, onNavigate: t}) {
    return (0,
    x.jsxs)(`footer`, {
        children: [(0,
        x.jsxs)(`div`, {
            ...
            x.jsxs)(`div`, {
                ...
                children: [(0,
                x.jsx)(`h4`, {
                    children: `JaJu Republics`
                }), (0,
                x.jsx)(`p`, {
                    children: `A democratic nation in Asia committed to unity, progress, and prosperity.`
                })]
            }), (0,
            x.jsxs)(`div`, {
                className: `footer-section`,
                ...
                x.jsx)(`ul`, {
                    children: S.map( ([n,r]) => (0,
                    x.jsx)(`li`, {
                        children: (0,
                        x.jsx)(`button`, {
                            type: `button`,
                            className: e === n ? `is-active` : void 0,
                            onClick: () => t(n),
                            children: r
                        })
                    }, n))
            ...
            x.jsxs)(`div`, {
                ...
                x.jsxs)(`ul`, {
                    children: [(0,
                    x.jsx)(`li`, {
                        children: `Government Type: Presidential Republic`
                    }), (0,
                    x.jsx)(`li`, {
                        children: `Legislature: KukHwae (국회)`
                    }), (0,
                    x.jsx)(`li`, {
                        children: `Location: Asia`
                    }), (0,
                    x.jsx)(`li`, {
                        children: `Currency: JRW`
                    }), (0,
                    x.jsx)(`li`, {
                        children: `System: Democratic`
                    })]
                })]
            }), (0,
            x.jsxs)(`div`, {
                ...
                x.jsxs)(`ul`, {
                    ...
                    x.jsx)(`li`, {
                        children: `Ministry of Information`
                    }), (0,
                    x.jsx)(`li`, {
                        children: `Tourist Information Center`
                    })]
                })]
            })]
        }), (0,
        x.jsxs)(`div`, {
            ...
            children: [(0,
            x.jsx)(`p`, {
                children: `© 2026 JaJu Republics. All rights reserved.`
            }), (0,
            x.jsx)(`p`, {
                children: `National Motto: "Unity, Progress, Prosperity"`
            })]
        })]
    })
}
function w() {
    ...
    x.jsxs)(`svg`, {
        ...
        x.jsx)(`path`, {
            d: `M 100 20 L 100 180 L 20 100 Z`,
            fill: `#ffffff`
        }), (0,
        x.jsx)(`path`, {
            d: `M 100 20 L 100 180 L 180 100 Z`,
            fill: `#0066ff`
        }), (0,
        x.jsx)(`circle`, {
            cx: `100`,
        ...
        x.jsx)(`path`, {
            d: `M 60 140 L 100 110 L 140 140`,
            fill: `#ff4a31`,
            opacity: `0.7`
        })]
    })
}
var T = [[`home`, `Home`], [`about`, `About Us`], [`geography`, `Geography`], [`government`, `Government`], [`economy`, `Economy`]];
function E({activeSection: e, onNavigate: t}) {
    return (0,
    x.jsx)(`header`, {
            ...
            x.jsxs)(`div`, {
                ...
                x.jsxs)(`div`, {
                    ...
                    x.jsx)(`p`, {
                        ...
                        children: `Republic of Imagination`
                    }), (0,
                    x.jsx)(`h1`, {
                        children: `JaJu Republics`
                    })]
...
function de(e, t, n) {
    let r = t[0]
      ...
      , o = n[3] * r + n[7] * i + n[11] * a + n[15];
    return o ||= 1,
    e[0] = (n[0] * r + n[4] * i + n[8] * a) / o,
    e[1] = (n[1] * r + n[5] * i + n[9] * a) / o,
    e[2] = (n[2] * r + n[6] * i + n[10] * a) / o,
    e
}
function fe(e, t, n) {
    let r = t[0]
...
var ge = class e extends Array {
    ...
    set(e, t=e, n=e) {
        return e.length ? this.copy(e) : (k(this, e, t, n),
        this)
    }
    copy(e) {
        return O(this, e),
    ...
    sub(e, t) {
        return t ? j(this, e, t) : j(this, this, e),
        this
    }
    multiply(e) {
        return e.length ? ee(this, this, e) : ne(this, this, e),
        this
    }
    divide(e) {
        return e.length ? te(this, this, e) : ne(this, this, 1 / e),
        this
    }
    inverse(e=this) {
        return ae(this, e),
    ...
    distance(e) {
        return e ? re(this, e) : D(this)
    }
    squaredLen() {
        return N(this)
    }
    squaredDistance(e) {
        return e ? M(this, e) : N(this)
    }
    negate(e=this) {
        return ie(this, e),
        this
    ...
    cross(e, t) {
        return t ? ce(this, e, t) : ce(this, this, e),
        this
    }
    scale(e) {
        return ne(this, this, e),
        this
    }
    normalize() {
        return oe(this, this),
    ...
    scaleRotateMatrix4(e) {
        return de(this, this, e),
        this
    }
    applyQuaternion(e) {
        return pe(this, this, e),
        this
    }
    angle(e) {
        return me(this, e)
    ...
    lerp(e, t) {
        return P(this, this, e, t),
        this
    }
    smoothLerp(e, t, n) {
        return le(this, this, e, t, n),
        this
    }
    clone() {
    ...
    transformDirection(e) {
        let t = this[0]
          , n = this[1]
          , r = this[2];
        return this[0] = e[0] * t + e[4] * n + e[8] * r,
        this[1] = e[1] * t + e[5] * n + e[9] * r,
        this[2] = e[2] * t + e[6] * n + e[10] * r,
        this.normalize()
    }
}
  , _e = new ge
  ...
  , xe = class {
    ...
    addAttribute(e, t) {
        ...
        t.divisor) {
            ...
            e === `index` ? this.drawRange.count = t.count : this.attributes.index || (this.drawRange.count = Math.max(this.drawRange.count, t.count))
    }
    updateAttribute(e) {
        let t = !e.buffer;
    ...
    bindAttributes(e) {
        e.attributeLocations.forEach( (e, {name: t, type: n}) => {
            ...
            let a = r.size / i
              ...
              , s = i === 1 ? 0 : i * 4;
            for (let t = 0; t < i; t++)
                this.gl.vertexAttribPointer(e + t, a, r.type, r.normalized, r.stride + o, r.offset + t * s),
                this.gl.enableVertexAttribArray(e + t),
                this.gl.renderer.vertexAttribDivisor(e + t, r.divisor)
        }
        ),
    ...
    draw({program: e, mode: t=this.gl.TRIANGLES}) {
        ...
        this.isInstanced ? this.attributes.index ? this.gl.renderer.drawElementsInstanced(t, this.drawRange.count, this.attributes.index.type, this.attributes.index.offset + this.drawRange.start * n, this.instancedCount) : this.gl.renderer.drawArraysInstanced(t, this.drawRange.start, this.drawRange.count, this.instancedCount) : this.attributes.index ? this.gl.drawElements(t, this.drawRange.count, this.attributes.index.type, this.attributes.index.offset + this.drawRange.start * n) : this.gl.drawArrays(t, this.drawRange.start, this.drawRange.count)
    }
    getPosition() {
    ...
    computeBoundingSphere(e) {
        ...
        for (let e = 0, i = t.length; e < i; e += n)
            _e.fromArray(t, e),
            r = Math.max(r, this.bounds.center.squaredDistance(_e));
  ...
  , Ce = {}
  , we = class {
    constructor(e, {vertex: t, fragment: n, uniforms: r={}, transparent: i=!1, cullFace: a=e.BACK, frontFace: o=e.CCW, depthTest: s=!0, depthWrite: c=!0, depthFunc: l=e.LEQUAL}={}) {
    ...
    setShaders({vertex: e, fragment: t}) {
        ...
        t && (this.gl.shaderSource(this.fragmentShader, t),
        ...
        for (let e = 0; e < i; e++) {
            ...
            n !== -1 && (r[n] = t.name,
            this.attributeLocations.set(t, n))
        }
    ...
    use({flipFaces: e=!1}={}) {
        ...
        this.uniformLocations.forEach( (e, n) => {
            ...
            if (!r)
                return je(`Active uniform ${n.name} has not been supplied`);
            if (r && r.value === void 0)
                return je(`${n.name} uniform is missing a value parameter`);
            if (r.value.texture)
                return t += 1,
                r.value.update(t),
                Te(this.gl, n.type, e, t);
            if (r.value.length && r.value[0].texture) {
                ...
                Te(this.gl, n.type, e, i)
            }
            Te(this.gl, n.type, e, r.value)
        }
        ),
        this.applyState(),
...
function Te(e, t, n, r) {
    ...
    if (r.length)
        if (i === void 0 || i.length !== r.length)
            e.renderer.state.uniformLocations.set(n, r.slice(0));
        else {
            if (Oe(i, r))
                return;
            i.set ? i.set(r) : ke(i, r),
...
var Ae = 0;
function je(e) {
    Ae > 100 || (console.warn(e),
    Ae++,
    Ae > 100 && console.warn(`More than 100 program warnings - stopping logs.`))
}
var Me = new ge
  , Ne = 1
  , Pe = class {
    ...
    setBlendFunc(e, t, n, r) {
        this.state.blendFunc.src === e && this.state.blendFunc.dst === t && this.state.blendFunc.srcAlpha === n && this.state.blendFunc.dstAlpha === r || (this.state.blendFunc.src = e,
        this.state.blendFunc.dst = t,
        this.state.blendFunc.srcAlpha = n,
        this.state.blendFunc.dstAlpha = r,
        n === void 0 ? this.gl.blendFunc(e, t) : this.gl.blendFuncSeparate(e, t, n, r))
    }
    setBlendEquation(e, t) {
        e ||= this.gl.FUNC_ADD,
        ...
        t === void 0 ? this.gl.blendEquation(e) : this.gl.blendEquationSeparate(e, t))
    }
    setCullFace(e) {
    ...
    setStencilMask(e) {
        this.state.stencilMask !== e && (this.state.stencilMask = e,
        this.gl.stencilMask(e))
    }
    setStencilFunc(e, t, n) {
        this.state.stencilFunc === e && this.state.stencilRef === t && this.state.stencilFuncMask === n || (this.state.stencilFunc = e || this.gl.ALWAYS,
        this.state.stencilRef = t || 0,
        this.state.stencilFuncMask = n || 0,
        this.gl.stencilFunc(e || this.gl.ALWAYS, t || 0, n || 0))
    }
    setStencilOp(e, t, n) {
        this.state.stencilFail === e && this.state.stencilDepthFail === t && this.state.stencilDepthPass === n || (this.state.stencilFail = e,
        this.state.stencilDepthFail = t,
        this.state.stencilDepthPass = n,
        this.gl.stencilOp(e, t, n))
    }
    activeTexture(e) {
    ...
    getRenderList({scene: e, camera: t, frustumCull: n, sort: r}) {
        ...
        r) {
            let e = []
              ...
              , r = [];
            i.forEach(i => {
                i.program.transparent ? i.program.depthTest ? n.push(i) : r.push(i) : e.push(i),
                i.zDepth = 0,
                !(i.renderOrder !== 0 || !i.program.depthTest || !t) && (i.worldMatrix.getTranslation(Me),
...
function Ge(e, t, n, r) {
    ...
    return p = i * c + a * l + o * u + s * d,
    p < 0 && (p = -p,
    c = -c,
    l = -l,
    u = -u,
    d = -d),
    1 - p > 1e-6 ? (f = Math.acos(p),
    m = Math.sin(f),
    h = Math.sin((1 - r) * f) / m,
    g = Math.sin(r * f) / m) : (h = 1 - r,
    g = r),
    e[0] = h * i + g * c,
    e[1] = h * a + g * l,
    e[2] = h * o + g * u,
...
function Je(e, t) {
    ...
    if (n > 0)
        ...
        let i = (n + 1) % 3
          , a = (n + 2) % 3;
        r = Math.sqrt(t[n * 3 + n] - t[i * 3 + i] - t[a * 3 + a] + 1),
        e[n] = .5 * r,
        r = .5 / r,
        e[3] = (t[i * 3 + a] - t[a * 3 + i]) * r,
        e[i] = (t[i * 3 + n] + t[n * 3 + i]) * r,
        e[a] = (t[a * 3 + n] + t[n * 3 + a]) * r
    }
    return e
}
function Ye(e, t, n=`YXZ`) {
    let r = Math.sin(t[0] * .5)
      ...
      , s = Math.sin(t[2] * .5)
      , c = Math.cos(t[2] * .5);
    return n === `XYZ` ? (e[0] = r * o * c + i * a * s,
    e[1] = i * a * c - r * o * s,
    e[2] = i * o * s + r * a * c,
    e[3] = i * o * c - r * a * s) : n === `YXZ` ? (e[0] = r * o * c + i * a * s,
    e[1] = i * a * c - r * o * s,
    e[2] = i * o * s - r * a * c,
    e[3] = i * o * c + r * a * s) : n === `ZXY` ? (e[0] = r * o * c - i * a * s,
    e[1] = i * a * c + r * o * s,
    e[2] = i * o * s + r * a * c,
    e[3] = i * o * c - r * a * s) : n === `ZYX` ? (e[0] = r * o * c - i * a * s,
    e[1] = i * a * c + r * o * s,
    e[2] = i * o * s - r * a * c,
    e[3] = i * o * c + r * a * s) : n === `YZX` ? (e[0] = r * o * c + i * a * s,
    e[1] = i * a * c + r * o * s,
    e[2] = i * o * s - r * a * c,
    e[3] = i * o * c - r * a * s) : n === `XZY` && (e[0] = r * o * c - i * a * s,
    e[1] = i * a * c - r * o * s,
    e[2] = i * o * s + r * a * c,
    e[3] = i * o * c + r * a * s),
    e
...
var Xe = Fe
  ...
  , et = class extends Array {
    constructor(e=0, t=0, n=0, r=1) {
        ...
        return new Proxy(this,{
            set(e, t) {
                ...
                return n && i.includes(t) && e.onChange(),
                n
            }
        })
    }
    ...
    identity() {
        return ze(this._target),
        this.onChange(),
        this
    }
    set(e, t, n, r) {
        return e.length ? this.copy(e) : (Ze(this._target, e, t, n, r),
        this.onChange(),
        this)
    }
    rotateX(e) {
        return He(this._target, this._target, e),
        this.onChange(),
        this
    }
    rotateY(e) {
        return Ue(this._target, this._target, e),
        this.onChange(),
        this
    }
    rotateZ(e) {
        return We(this._target, this._target, e),
        this.onChange(),
        this
    }
    inverse(e=this._target) {
        return Ke(this._target, e),
        this.onChange(),
        this
    }
    conjugate(e=this._target) {
        return qe(this._target, e),
        this.onChange(),
        this
    }
    copy(e) {
    ...
    normalize(e=this._target) {
        return $e(this._target, e),
        this.onChange(),
        this
    }
    multiply(e, t) {
        return t ? Ve(this._target, e, t) : Ve(this._target, this._target, e),
        this.onChange(),
        this
    }
    dot(e) {
    ...
    fromMatrix3(e) {
        return Je(this._target, e),
        this.onChange(),
        this
    }
    fromEuler(e, t) {
        return Ye(this._target, e, e.order),
        t || this.onChange(),
        this
    }
    fromAxisAngle(e, t) {
        return Be(this._target, e, t),
        this.onChange(),
        this
    }
    slerp(e, t) {
        return Ge(this._target, this._target, e, t),
        this.onChange(),
        this
    }
    fromArray(e, t=0) {
        return this._target[0] = e[t],
...
function rt(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g) {
    return e[0] = t,
    e[1] = n,
    e[2] = r,
    e[3] = i,
...
function ct(e, t, n) {
    ...
    return t === e ? (e[12] = t[0] * r + t[4] * i + t[8] * a + t[12],
    e[13] = t[1] * r + t[5] * i + t[9] * a + t[13],
    e[14] = t[2] * r + t[6] * i + t[10] * a + t[14],
    e[15] = t[3] * r + t[7] * i + t[11] * a + t[15]) : (o = t[0],
    s = t[1],
    c = t[2],
    l = t[3],
    u = t[4],
...
function ut(e, t, n, r) {
    ...
    return Math.abs(s) < tt ? null : (s = 1 / s,
    i *= s,
    a *= s,
    o *= s,
    c = Math.sin(n),
...
function ft(e, t) {
    ...
    e[1] = Math.hypot(a, o, s),
    e[2] = Math.hypot(c, l, u),
    e
}
function pt(e) {
    let t = e[0]
...
var mt = (function() {
    ...
    return function(t, n) {
        ...
        let i = 1 / r[0]
          ...
          , g = s + d + h
          , _ = 0;
        return g > 0 ? (_ = Math.sqrt(g + 1) * 2,
        t[3] = .25 * _,
        t[0] = (f - m) / _,
        t[1] = (p - l) / _,
        t[2] = (c - u) / _) : s > d && s > h ? (_ = Math.sqrt(1 + s - d - h) * 2,
        t[3] = (f - m) / _,
        t[0] = .25 * _,
        t[1] = (c + u) / _,
        t[2] = (p + l) / _) : d > h ? (_ = Math.sqrt(1 + d - s - h) * 2,
        t[3] = (p - l) / _,
        t[0] = (c + u) / _,
        t[1] = .25 * _,
        t[2] = (f + m) / _) : (_ = Math.sqrt(1 + h - s - d) * 2,
        t[3] = (c - u) / _,
        t[0] = (p + l) / _,
        t[1] = (f + m) / _,
        t[2] = .25 * _),
...
function bt(e, t, n, r) {
    ...
    let m = c * f - l * d
      , h = l * u - s * f
      , g = s * d - c * u;
    return p = m * m + h * h + g * g,
    p === 0 && (l ? s += 1e-6 : c ? l += 1e-6 : c += 1e-6,
    m = c * f - l * d,
    h = l * u - s * f,
    g = s * d - c * u,
    p = m * m + h * h + g * g),
...
var wt = class extends Array {
    constructor(e=1, t=0, n=0, r=0, i=0, a=1, o=0, s=0, c=0, l=0, u=1, d=0, f=0, p=0, m=0, h=1) {
        return super(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h),
        this
    }
    get x() {
        return this[12]
    ...
    set(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h) {
        return e.length ? this.copy(e) : (rt(this, e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h),
        this)
    }
    translate(e, t=this) {
        return ct(this, t, e),
    ...
    rotate(e, t, n=this) {
        return ut(this, n, e, t),
        this
    }
    scale(e, t=this) {
        return lt(this, t, typeof e == `number` ? [e, e, e] : e),
        this
    }
    add(e, t) {
        return t ? xt(this, e, t) : xt(this, this, e),
        this
    }
    sub(e, t) {
        return t ? St(this, e, t) : St(this, this, e),
        this
    }
    multiply(e, t) {
        return e.length ? t ? st(this, e, t) : st(this, this, e) : Ct(this, this, e),
        this
    }
    identity() {
        return it(this),
...
var Et = new wt
  , Dt = class extends Array {
    ...
    fromRotationMatrix(e, t=this.order) {
        return Tt(this._target, e, t),
        this.onChange(),
        this
    }
    fromQuaternion(e, t=this.order, n) {
        return Et.fromQuaternion(e),
        this._target.fromRotationMatrix(Et, t),
        n || this.onChange(),
        this
    }
    fromArray(e, t=0) {
  ...
  , Ot = class {
    constructor() {
        ...
        this.visible = !0,
        this.matrix = new wt,
        this.worldMatrix = new wt,
        this.matrixAutoUpdate = !0,
        this.worldMatrixNeedsUpdate = !1,
        this.position = new ge,
        this.quaternion = new et,
        this.scale = new ge(1),
        this.rotation = new Dt,
        this.up = new ge(0,1,0),
...
var Bt = class extends Array {
    constructor(e=1, t=0, n=0, r=0, i=1, a=0, o=0, s=0, c=1) {
        return super(e, t, n, r, i, a, o, s, c),
        this
    }
    set(e, t, n, r, i, a, o, s, c) {
        return e.length ? this.copy(e) : (Mt(this, e, t, n, r, i, a, o, s, c),
        this)
    }
    translate(e, t=this) {
        return It(this, t, e),
    ...
    multiply(e, t) {
        return t ? Ft(this, e, t) : Ft(this, this, e),
        this
    }
    identity() {
        return Nt(this),
  ...
  , Ht = class extends Ot {
    constructor(e, {geometry: t, program: n, mode: r=e.TRIANGLES, frustumCulled: i=!0, renderOrder: a=0}={}) {
        ...
        this.renderOrder = a,
        this.modelViewMatrix = new wt,
        this.normalMatrix = new Bt,
...
function Kt(e) {
    return e === void 0 ? [0, 0, 0] : arguments.length === 3 ? arguments : isNaN(e) ? e[0] === `#` ? Wt(e) : Ut[e.toLowerCase()] ? Wt(Ut[e.toLowerCase()]) : (console.warn(`Color format not recognised`),
    [0, 0, 0]) : Gt(e)
}
var qt = class extends Array {
    constructor(e) {
        return super(...Array.isArray(e) ? e : Kt(...arguments))
    }
    get r() {
        return this[0]
    }
    ...
    set(e) {
        return Array.isArray(e) ? this.copy(e) : this.copy(Kt(...arguments))
    }
    copy(e) {
        return this[0] = e[0],
        this[1] = e[1],
...
`;
function Zt({focal: e=[.5, .5], rotation: t=[1, 0], starSpeed: n=.5, density: r=1, hueShift: i=140, disableAnimation: a=!1, speed: o=1, mouseInteraction: s=!0, glowIntensity: c=.3, saturation: l=0, mouseRepulsion: u=!0, repulsionStrength: d=2, twinkleIntensity: f=.3, rotationSpeed: p=.1, autoCenterRepulsion: m=0, transparent: h=!0, ...g}) {
    let _ = (0,
    y.useRef)(null)
      , v = (0,
    y.useRef)({
    ...
    y.useEffect)( () => {
        ...
        x.clearColor(0, 0, 0, 0)) : x.clearColor(0, 0, 0, 1);
        let w;
        function T() {
            y.setSize(g.offsetWidth * 1, g.offsetHeight * 1),
            w && (w.uniforms.uResolution.value = new qt(x.canvas.width,x.canvas.height,x.canvas.width / x.canvas.height))
        }
        ...
        w = new we(x,{
            ...
            uniforms: {
                ...
                uResolution: {
                    value: new qt(x.canvas.width,x.canvas.height,x.canvas.width / x.canvas.height)
                },
                uFocal: {
                ...
                uMouse: {
                    value: new Float32Array([b.current.x, b.current.y])
                },
                uGlowIntensity: {
                    value: c
                },
        ...
        function k(e) {
            ...
            a || (w.uniforms.uTime.value = e * .001,
            w.uniforms.uStarSpeed.value = e * .001 * n / 10);
            let t = .05;
            b.current.x += (v.current.x - b.current.x) * t,
            b.current.y += (v.current.y - b.current.y) * t,
            C.current += (S.current - C.current) * t,
            w.uniforms.uMouse.value[0] = b.current.x,
            w.uniforms.uMouse.value[1] = b.current.y,
            w.uniforms.uMouseActiveFactor.value = C.current,
            y.render({
                scene: D
            })
        }
        O = requestAnimationFrame(k),
        g.appendChild(x.canvas);
        function A(e) {
            let t = g.getBoundingClientRect();
            v.current = {
                x: (e.clientX - t.left) / t.width,
                y: 1 - (e.clientY - t.top) / t.height
            },
            S.current = 1
        }
        function j() {
        ...
        return s && (g.addEventListener(`mousemove`, A),
        g.addEventListener(`mouseleave`, j)),
        () => {
            cancelAnimationFrame(O),
            window.removeEventListener(`resize`, T),
            s && (g.removeEventListener(`mousemove`, A),
            g.removeEventListener(`mouseleave`, j)),
            g.removeChild(x.canvas),
            x.getExtension(`WEBGL_lose_context`)?.loseContext()
        }
    }
    , [e, t, n, r, i, a, o, s, c, l, u, f, p, d, m, h]),
    (0,
    x.jsx)(`div`, {
        ref: _,
...
function Qt() {
    ...
    x.jsxs)(`svg`, {
        ...
        x.jsx)(`path`, {
            d: `m105 65a40 40 0 1 1 0-1z`,
            fill: `#ff4a31`
        }), (0,
        x.jsx)(`path`, {
            d: `m30.5 73.5c1-11 4-28 21-35 4 39 45 14 23-8 9 6 22 17 20 35-35-16-35 32-4 24-10 5-26 11-41 0 32-22-10-46-19-16`
        })]
    })
}
var $t = [{
    ...
    label: `National Slogan`,
    value: `귤이냐 굴이냐, 둘다 맜있다.`
}, {
    label: `English Translation`,
    value: `"Mandarin or oyster? Both are just delicious."`
}]
  , en = [{
    ...
    x.jsxs)(`section`, {
        ...
        x.jsxs)(`div`, {
            ...
            x.jsxs)(`div`, {
                ...
                x.jsx)(`h2`, {
                    children: `A Nation Full of Up & Downs`
                }), (0,
                x.jsx)(`p`, {
                    className: `about-hero__lead`,
                    children: `JaJu Republics gives you a taste of diversity and abundance. The page is now rebuilt in JSX so we can keep growing it with React-based experiences and animated visual layers.`
                }), (0,
                x.jsxs)(`p`, {
                    className: `about-hero__tagline`,
                    children: [`National Motto: `, (0,
                    x.jsx)(`em`, {
                        children: `"Unity, Progress, Prosperity"`
                    })]
                })]
            })]
        }), (0,
        x.jsxs)(`div`, {
            ...
            x.jsxs)(`details`, {
                id: `identity`,
                className: `panel panel--featured content-panel content-panel--dark`,
                open: !0,
                children: [(0,
                x.jsx)(`summary`, {
                    className: `content-panel__summary`,
                    children: (0,
                    x.jsx)(`span`, {
                        children: `National Identity`
                    })
                }), (0,
                x.jsxs)(`div`, {
                    className: `panel__header content-panel__body`,
                    children: [(0,
                    x.jsxs)(`div`, {
                        children: [(0,
                        x.jsx)(`h3`, {
                        ...
                        x.jsx)(`p`, {
                            className: `country-tagline`,
                            children: `A Nation full of Up & Downs`
                        })]
                    }), (0,
                    x.jsx)(`div`, {
                        className: `flag-card`,
                        "aria-label": `JaJu Republics flag`,
                        children: (0,
                        x.jsx)(Qt, {})
                    })]
                }), (0,
                ...
                x.jsx)(`p`, {
                    ...
                    children: `JaJu Republics gives you a great taste of diversity and abundance. For the suite and scent of the fresh, JaJu Republics' wave of the waters will stress you down.`
                })]
            }), (0,
            x.jsxs)(`aside`, {
                id: `values`,
                ...
                children: [(0,
                x.jsxs)(`details`, {
                    className: `panel panel--soft content-panel content-panel--dark`,
                    open: !0,
                    children: [(0,
                    x.jsx)(`summary`, {
                        className: `content-panel__summary`,
                    ...
                    x.jsxs)(`div`, {
                        ...
                        children: [(0,
                        x.jsx)(`h3`, {
                            children: `Why move this into React?`
                        }), (0,
                        x.jsx)(`p`, {
                            children: `React gives this project room to grow beyond a single static page. We can break sections into components, plug in React Bits-style visuals, and keep the content easier to maintain.`
                        })]
                    })]
                }), (0,
                x.jsx)(`div`, {
                    ...
                    children: en.map(e => (0,
                    x.jsxs)(`details`, {
                        className: `panel value-card content-panel content-panel--dark`,
                        children: [(0,
                        x.jsx)(`summary`, {
                            className: `content-panel__summary`,
                            children: (0,
...
var nn = 73.7
  , rn = [[`Mandarins and orange products`, `JaJu Republics can sell fresh oranges, orange juice, candy, and skincare made with citrus.`], [`Seafood`, `Fishing and ocean farming can help the country sell fish, oysters, seaweed, and other ocean foods.`], [`Tourism`, `Visitors can spend money on beaches, mountains, local food, hotels, and cultural trips.`], [`Green energy ideas`, `Because the country is windy and coastal, it can specialize in wind power and clean energy projects.`]]
  , an = [[`Oil and fuel`, `The country would need fuel for cars, ships, planes, and factories.`], [`Electronics and machines`, `It may import phones, computers, farming machines, and factory tools.`], [`Some foods`, `Even with farming and fishing, the country may still need rice, wheat, meat, and other foods.`], [`Building materials`, `Steel, lumber, and cement may be needed for roads, schools, ports, and homes.`]];
function on() {
    let e = 80 + nn / 100 * 520;
    return (0,
    x.jsxs)(`svg`, {
        className: `continuum-svg`,
        viewBox: `0 0 680 210`,
        role: `img`,
        "aria-label": `Economic systems continuum showing JaJu Republics at 73.7 percent economic freedom`,
        children: [(0,
        x.jsxs)(`defs`, {
            children: [(0,
        ...
        x.jsx)(`text`, {
            x: `80`,
            y: `54`,
            className: `continuum-label`,
            children: `Command Economy`
        }), (0,
        x.jsx)(`text`, {
            x: `340`,
            y: `54`,
            className: `continuum-label continuum-label--middle`,
            children: `Mixed Economy`
        }), (0,
        x.jsx)(`text`, {
            x: `600`,
            y: `54`,
            className: `continuum-label continuum-label--end`,
            children: `Market Economy`
        }), (0,
        x.jsx)(`line`, {
            x1: `80`,
            y1: `105`,
        ...
        x.jsxs)(`g`, {
            ...
            children: [(0,
            x.jsx)(`path`, {
                d: `M ${e} 70 L ${e - 18} 112 L ${e + 18} 112 Z`,
                fill: `#07111f`
            }), (0,
            x.jsx)(`circle`, {
                cx: e,
        ...
        x.jsxs)(`text`, {
            x: e,
            y: `154`,
            className: `continuum-percent`,
            children: [nn, `%`]
        }), (0,
        x.jsx)(`text`, {
            x: e,
            y: `176`,
            className: `continuum-country`,
            children: `JaJu Republics`
        }), (0,
        x.jsx)(`text`, {
            x: `80`,
            y: `172`,
            className: `continuum-small`,
            children: `less business freedom`
        }), (0,
        x.jsx)(`text`, {
            x: `600`,
            y: `172`,
            className: `continuum-small continuum-label--end`,
            children: `more business freedom`
        })]
    })
}
function sn() {
    ...
    x.jsxs)(`svg`, {
        ...
        viewBox: `0 0 760 330`,
        role: `img`,
        "aria-label": `A JaJu Republics Won banknote inspired by Korean won with oranges on the right side`,
        children: [(0,
        x.jsxs)(`defs`, {
            children: [(0,
            x.jsxs)(`linearGradient`, {
        ...
        x.jsx)(`path`, {
            d: `M172 108 C200 136 203 193 172 224 C141 193 144 136 172 108Z`,
            fill: `#0066ff`,
            opacity: `0.86`
        }), (0,
        x.jsx)(`path`, {
            d: `M116 166 C144 138 201 135 228 166 C201 197 144 194 116 166Z`,
            fill: `#ff4a31`,
            opacity: `0.9`
        }), (0,
        x.jsx)(`circle`, {
        ...
        x.jsx)(`text`, {
            ...
            children: `BANK OF JA-JU REPUBLICS`
        }), (0,
        x.jsx)(`text`, {
            x: `286`,
            y: `166`,
        ...
        x.jsx)(`text`, {
            ...
            children: `JAJU REPUBLICS WON`
        }), (0,
        x.jsx)(`text`, {
            x: `286`,
            y: `238`,
            className: `currency-script`,
            children: `귤과 바다의 돈`
        }), (0,
        x.jsxs)(`g`, {
            className: `orange-cluster`,
            children: [(0,
            x.jsx)(`circle`, {
                cx: `595`,
                cy: `128`,
            ...
            x.jsx)(`path`, {
                d: `M593 78 C605 57 632 54 651 72 C627 83 613 87 593 78Z`,
                fill: `#2f9e44`
            }), (0,
            x.jsx)(`path`, {
                d: `M641 114 C659 95 690 101 704 123 C676 126 660 126 641 114Z`,
                fill: `#3aad52`
            }), (0,
            x.jsx)(`path`, {
                d: `M551 174 C566 151 594 148 613 166 C587 179 569 181 551 174Z`,
                fill: `#287d3c`
            }), (0,
            x.jsx)(`path`, {
                d: `M562 117 C577 137 583 157 579 185`,
                fill: `none`,
                stroke: `#d95f00`,
                strokeWidth: `5`,
                strokeLinecap: `round`,
            ...
            x.jsx)(`path`, {
                d: `M618 145 C638 162 649 186 649 215`,
                fill: `none`,
                stroke: `#d95f00`,
                strokeWidth: `5`,
                strokeLinecap: `round`,
        ...
        x.jsx)(`text`, {
            x: `70`,
            y: `286`,
            className: `currency-serial`,
            children: `JRW 2026 0737`
        }), (0,
        x.jsx)(`text`, {
            x: `700`,
            y: `286`,
            className: `currency-corner`,
            children: `1000`
        }), (0,
        x.jsx)(`text`, {
            x: `60`,
...
function cn() {
    ...
    x.jsx)(`div`, {
        ...
        "aria-label": `USD to KRW exchange rate widget`
    })
}
function ln() {
    return (0,
    x.jsxs)(`section`, {
        id: `economy`,
        className: `container page-section economy-section`,
        children: [(0,
        x.jsx)(`h2`, {
            className: `page-heading`,
            children: `Economy of JaJu Republics`
        }), (0,
        x.jsxs)(`details`, {
            className: `economy-card content-panel`,
            open: !0,
            children: [(0,
            x.jsx)(`summary`, {
                className: `content-panel__summary`,
                children: (0,
                x.jsx)(`span`, {
                    children: `Economic Systems Continuum`
                })
            }), (0,
            x.jsxs)(`div`, {
                className: `content-panel__body economy-layout economy-layout--continuum`,
                children: [(0,
                x.jsx)(on, {}), (0,
                x.jsxs)(`div`, {
                    className: `economy-note`,
                    children: [(0,
                    x.jsx)(`h3`, {
                        children: `Where does JaJu Republics fall?`
                    }), (0,
                    x.jsxs)(`p`, {
                        children: [`JaJu Republics is placed at `, (0,
                        x.jsx)(`strong`, {
                            children: `73.7% economic freedom`
                        }), `. This means it is mostly a market economy, but the government still helps with rules, schools, roads, health, and protecting workers.`]
                    }), (0,
                    x.jsx)(`p`, {
                        children: `I put it here because businesses can open, people can choose jobs, and trade is important. But it is not 100% free because the country still needs laws to keep the environment safe and make sure people are treated fairly.`
                    })]
                })]
            })]
        }), (0,
        x.jsxs)(`details`, {
            ...
            x.jsxs)(`div`, {
                className: `content-panel__body economy-layout`,
                children: [(0,
                x.jsxs)(`div`, {
                    className: `economy-note`,
                    children: [(0,
                    x.jsx)(`h3`, {
                        children: `Name of Currency`
                    }), (0,
                    x.jsxs)(`p`, {
                        children: [`The currency is called `, (0,
                        x.jsx)(`strong`, {
                            children: `JRW`
                        }), `, which means `, (0,
                        x.jsx)(`strong`, {
                            children: `JaJu Republics Won`
                        }), `. It is based on Korean won style because JaJu Republics is inspired by Korean island culture.`]
                    })]
                }), (0,
                x.jsx)(sn, {})]
            })]
        ...
        x.jsxs)(`details`, {
            ...
            x.jsxs)(`div`, {
                className: `content-panel__body exchange-layout`,
                children: [(0,
                x.jsxs)(`div`, {
                    className: `economy-note`,
                    children: [(0,
                    x.jsx)(`h3`, {
                        children: `Exchange Rate Tool`
                    }), (0,
                    x.jsx)(`p`, {
                        children: `This widget compares the United States dollar with the Korean won. JaJu Republics uses JRW, but this gives a good example because JRW is based on KRW.`
                    })]
                }), (0,
                x.jsx)(cn, {})]
            })]
        ...
        x.jsxs)(`details`, {
            ...
            x.jsx)(`summary`, {
                ...
                children: (0,
                x.jsx)(`span`, {
                    children: `Exports and Imports`
                })
            }), (0,
            x.jsxs)(`div`, {
                className: `content-panel__body trade-layout`,
                children: [(0,
                x.jsxs)(`div`, {
                    children: [(0,
                    x.jsx)(`h3`, {
                        children: `Major Exports and Specializations`
                    }), (0,
                    x.jsx)(`div`, {
                        className: `trade-grid`,
                        children: rn.map( ([e,t]) => (0,
                        x.jsxs)(`article`, {
                ...
                x.jsxs)(`div`, {
                    children: [(0,
                    x.jsx)(`h3`, {
                        children: `What JaJu Might Import`
                    }), (0,
                    x.jsx)(`div`, {
                        className: `trade-grid`,
                        children: an.map( ([e,t]) => (0,
                        x.jsxs)(`article`, {
                            className: `trade-card`,
                            children: [(0,
                            x.jsx)(`h4`, {
...
var un = [[`Winter`, `0-7°C`, `Mild and relatively dry season`], [`Spring`, `7-15°C`, `Gradual warming with blooming flowers`], [`Summer`, `20-28°C`, `Warm and humid with monsoon rains`], [`Fall`, `12-20°C`, `Cool and comfortable weather`]]
  , dn = [{
    title: `1. Hallasan Mountain`,
    lines: [`Height: 1,950m (Highest peak in the region)`, `Geological Origin: Volcanic mountain with a crater at the summit`, `Visitor Experience: This iconic stratovolcano attracts thousands of hikers annually with panoramic summit views and a serene crater lake.`]
}, {
    title: `2. Scenic Waterfalls`,
    lines: [`Notable Falls: Cheonjeyeon Falls, Jeongbang Falls, Yeongwol Falls`, `Geological Significance: Formed by volcanic basalt layers and spring water`, `Visitor Experience: The waterfalls create lush natural pools and a calming, photographic escape for families and casual tourists.`]
}, {
    title: `3. Black Sand Beaches`,
    lines: [`Formation: Volcanic sand created from basaltic rock erosion`, `Unique Characteristics: Distinctive black coloration with therapeutic mineral-rich sand`, `Visitor Experience: Visitors enjoy dramatic coastlines, sunset walks, and uncrowded volcanic shores.`]
}]
  , fn = {
    causes: [`Tourist Activities: Increased coastal tourism generates significant plastic waste from food packaging, beverages, and single-use plastics`, `Ocean Currents: Regional ocean currents bring plastic waste from neighboring countries to our shores`, `Fishing Industry: Discarded fishing nets, buoys, and equipment contribute to marine debris`, `Inadequate Waste Management: Limited recycling infrastructure and improper disposal practices in coastal areas`, `Global Consumption: Excessive use of single-use plastics flows into marine ecosystems`],
    effects: [`Marine Life Harm: Sea turtles, dolphins, and seabirds mistake plastic for food, causing injury and death`, `Ecosystem Degradation: Plastic accumulation damages coral reefs and disrupts marine food chains`, `Microplastic Contamination: Plastic breakdown creates microplastics that enter the food web, affecting both aquatic life and human consumption`, `Tourism Impact: Polluted beaches reduce aesthetic appeal and threaten tourism-dependent communities`, `Economic Loss: Costs for beach cleanup and ecological restoration strain government budgets`, `Public Health Concerns: Toxic chemicals from plastics leach into water supplies and seafood`],
    solutions: [[`Reduce Single-Use Plastics`, `Ban plastic bags, straws, and packaging while promoting reusable alternatives through policy and education.`], [`Enhanced Recycling Programs`, `Establish waste sorting systems at beaches and tourist areas with convenient collection points.`], [`Community Beach Cleanups`, `Organize regular coastal cleanup drives involving local communities, tourists, and volunteers.`], [`Education & Awareness`, `Launch public awareness campaigns and include marine conservation in school curricula and tourism guides.`], [`International Cooperation`, `Collaborate with neighboring regions to address cross-border pollution and share best practices.`], [`Innovation & Research`, `Invest in biodegradable materials, sustainable packaging, and new cleanup technologies.`]]
};
function pn() {
    return (0,
    x.jsxs)(`section`, {
        ...
        x.jsxs)(`details`, {
            className: `geography-card content-panel`,
            open: !0,
            children: [(0,
            x.jsx)(`summary`, {
                className: `content-panel__summary`,
            ...
            x.jsx)(`div`, {
                className: `map-container content-panel__body`,
                children: (0,
                x.jsx)(`iframe`, {
        ...
        x.jsxs)(`details`, {
            ...
            x.jsxs)(`div`, {
                className: `climate-info content-panel__body`,
                children: [(0,
                x.jsxs)(`p`, {
                    children: [`JaJu Republics features a `, (0,
                    x.jsx)(`strong`, {
                        children: `subtropical climate`
                    }), ` with distinct seasonal characteristics:`]
                }), (0,
                x.jsx)(`div`, {
                    className: `climate-grid`,
                    children: un.map( ([e,t,n]) => (0,
                    x.jsxs)(`div`, {
                ...
                x.jsxs)(`div`, {
                    ...
                    x.jsxs)(`p`, {
                        children: [(0,
                        x.jsx)(`strong`, {
                            children: `Peak Rain Season:`
                        }), ` June-August (monsoon)`]
                    }), (0,
                    x.jsxs)(`p`, {
                        children: [(0,
                        x.jsx)(`strong`, {
                            children: `Typhoon Season:`
                        }), ` August-September`]
                    })]
                })]
            })]
        ...
        x.jsxs)(`details`, {
            ...
            x.jsx)(`summary`, {
                ...
                children: (0,
                x.jsx)(`span`, {
                    children: `Major Physical Features`
                })
            }), (0,
            x.jsx)(`div`, {
                className: `features-grid content-panel__body`,
                children: dn.map(e => (0,
                x.jsxs)(`div`, {
        ...
        x.jsxs)(`details`, {
            className: `geography-card environmental-issue content-panel`,
            children: [(0,
            x.jsx)(`summary`, {
                className: `content-panel__summary`,
                children: (0,
                x.jsx)(`span`, {
                    children: `Major Environmental Challenge: Marine Litter & Plastic Pollution`
                })
            }), (0,
            x.jsxs)(`div`, {
                className: `content-panel__body`,
                ...
                x.jsxs)(`div`, {
                    ...
                    x.jsx)(`div`, {
                        ...
                        children: fn.solutions.map( ([e,t]) => (0,
                        x.jsxs)(`div`, {
...
var mn = [{
  ...
  , hn = [[`Voting Rights`, `All citizens have the right to vote in presidential, legislative, and local elections.`], [`Direct Action`, `Citizens can engage in peaceful demonstrations, assemblies, and public advocacy.`], [`Digital Platforms`, `Online civic portals allow citizens to petition the government and report issues.`], [`Participatory Budgeting`, `Citizens can propose and vote on how public funds are allocated.`], [`Right to Protest`, `Citizens have the constitutional right to peaceful protest and assembly.`], [`Public Consultation`, `Major decisions include hearings and consultation periods where citizens can provide input.`]]
  , gn = [[`Freedom of Speech`, `Citizens may freely express opinions and ideas. Incitement and hate crimes carry legal consequences.`], [`Freedom of Religion`, `All citizens have the right to practice any religion or none.`], [`Freedom of Press`, `Free and independent media is protected.`], [`Freedom of Movement`, `Citizens may travel freely within and outside the country.`], [`Right to Fair Trial`, `All citizens have the right to due process and legal representation.`], [`Privacy Rights`, `Personal privacy is protected by law.`]]
  , _n = [[`Primary Education`, `6 Years (Ages 6-12)`, `Foundational learning in literacy, numeracy, sciences, humanities, and life skills.`], [`Middle School`, `3 Years (Ages 12-15)`, `Intermediate education with expanded curriculum including languages, social studies, arts, and technology.`], [`High School`, `3 Years (Ages 15-18)`, `Advanced academics or specialized vocational training with academic and technical tracks.`], [`Higher Education`, `4+ Years (Post-Secondary)`, `Universities and colleges offering bachelor's, master's, and doctoral degrees.`]]
  , vn = [{
  ...
  , yn = [[`Defense Doctrine`, [`No territorial aggression; defensive posture only`, `Commitment to peaceful resolution of conflicts`, `Deterrence through strength and readiness`, `Protection of citizens and national sovereignty`]], [`Military Priorities`, [`Homeland security and territorial defense`, `Disaster relief and humanitarian assistance`, `Coast guard and maritime security`, `Technological advancement in defense systems`]], [`Peace Initiatives`, [`Diplomatic engagement with neighboring nations`, `Participation in international peacekeeping`, `Support for conflict resolution mechanisms`, `Commitment to international law and treaties`]]];
function bn() {
    return (0,
    x.jsxs)(`section`, {
        id: `government`,
        className: `container page-section government-section`,
        children: [(0,
        x.jsx)(`h2`, {
            className: `page-heading`,
            children: `Government of JaJu Republics`
        }), (0,
        x.jsxs)(`details`, {
            className: `gov-intro content-panel`,
            open: !0,
            children: [(0,
            x.jsx)(`summary`, {
                className: `content-panel__summary`,
            ...
            x.jsxs)(`div`, {
                ...
                x.jsxs)(`p`, {
                    children: [(0,
                    x.jsx)(`strong`, {
                        children: `Government Type:`
                    }), ` Presidential Republic`]
                }), (0,
                x.jsxs)(`p`, {
                    children: [(0,
                    x.jsx)(`strong`, {
                        children: `National Motto:`
                    }), ` "Unity, Progress, Prosperity"`]
                }), (0,
                x.jsx)(`p`, {
                    children: `JaJu Republics operates as a democratic presidential republic with a strong emphasis on citizen participation and representative democracy.`
                })]
            })]
        }), (0,
        x.jsxs)(`details`, {
            className: `gov-section content-panel`,
            open: !0,
            children: [(0,
            x.jsx)(`summary`, {
                className: `content-panel__summary`,
                children: (0,
                x.jsx)(`span`, {
                    children: `Government Structure`
                })
            }), (0,
            x.jsx)(`div`, {
                className: `gov-grid content-panel__body`,
                children: mn.map(e => (0,
                x.jsxs)(`article`, {
                    className: `gov-card`,
                    children: [(0,
        ...
        x.jsxs)(`details`, {
            ...
            x.jsx)(`summary`, {
                ...
                children: (0,
                x.jsx)(`span`, {
                    children: `Citizen Participation`
                })
            }), (0,
            x.jsxs)(`div`, {
                className: `content-panel__body`,
                children: [(0,
                x.jsx)(`p`, {
                    children: `JaJu Republics empowers its citizens to participate actively in governance through multiple channels:`
                }), (0,
                x.jsx)(`div`, {
                    className: `participation-grid`,
                    children: hn.map( ([e,t]) => (0,
                    x.jsxs)(`article`, {
        ...
        x.jsxs)(`details`, {
            ...
            x.jsx)(`summary`, {
                ...
                children: (0,
                x.jsx)(`span`, {
                    children: `Freedoms & Civil Liberties`
                })
            }), (0,
            x.jsxs)(`div`, {
                className: `content-panel__body`,
                children: [(0,
                x.jsx)(`p`, {
                    children: `JaJu Republics guarantees comprehensive freedoms and civil liberties to all citizens, with responsible limitations.`
                }), (0,
                x.jsx)(`div`, {
                    className: `freedoms-grid`,
                    children: gn.map( ([e,t]) => (0,
                    x.jsxs)(`article`, {
                        className: `freedom-card`,
                        children: [(0,
                        x.jsx)(`h4`, {
                            children: e
                        }), (0,
                ...
                x.jsx)(`div`, {
                    className: `freedoms-warning`,
                    children: (0,
                    x.jsxs)(`p`, {
                        children: [(0,
                        x.jsx)(`strong`, {
                            children: `Important Note:`
                        }), ` Misuse of these freedoms through hate crimes, violence, religious extremism, or incitement results in legal consequences.`]
                    })
                })]
            })]
        }), (0,
        x.jsxs)(`details`, {
            ...
            x.jsxs)(`div`, {
                ...
                children: [(0,
                x.jsx)(`p`, {
                    children: `JaJu Republics provides comprehensive, government-supported education following a model adapted from South Korea's successful system.`
                }), (0,
                x.jsxs)(`div`, {
                    className: `education-structure`,
                    children: [(0,
                    x.jsx)(`h4`, {
                        children: `Educational Pathway`
                    }), (0,
                    x.jsx)(`div`, {
                        className: `education-grid`,
                        children: _n.map( ([e,t,n]) => (0,
                        x.jsxs)(`article`, {
                ...
                x.jsx)(`h4`, {
                    children: `Specialized Training & Vocational Education`
                }), (0,
                x.jsx)(`div`, {
                    className: `vocational-programs`,
                    children: vn.map(e => (0,
                    x.jsxs)(`article`, {
        ...
        x.jsxs)(`details`, {
            ...
            x.jsx)(`summary`, {
                ...
                children: (0,
                x.jsx)(`span`, {
                    children: `National Defense & Military Policy`
                })
            }), (0,
            x.jsxs)(`div`, {
                className: `content-panel__body`,
                children: [(0,
                x.jsx)(`p`, {
                    children: `JaJu Republics follows a defense-first military doctrine, prioritizing peace and security while maintaining strong deterrence capabilities.`
                }), (0,
                x.jsx)(`div`, {
                    className: `defense-grid`,
                    children: yn.map( ([e,t]) => (0,
                    x.jsxs)(`article`, {
                ...
                x.jsx)(`div`, {
                    className: `war-stance`,
                    children: (0,
                    x.jsxs)(`p`, {
                        children: [(0,
                        x.jsx)(`strong`, {
                            children: `Position on War:`
                        }), ` War should be an absolute last resort. JaJu Republics maintains a strong military as a defensive deterrent, not for aggression.`]
                    })
                })]
            })]
        })]
...
var F = {
    ...
    overwrite: !1,
    delay: 0
}, wn, Tn, En, Dn = 1e8, I = 1 / Dn, On = Math.PI * 2, kn = On / 4, An = 0, jn = Math.sqrt, Mn = Math.cos, Nn = Math.sin, Pn = function(e) {
...
, Un = Array.isArray, Wn = /random\([^)]+\)/g, Gn = /,\s*/g, Kn = /(?:-?\.?\d|\.)+/gi, qn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Jn = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Yn = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Xn = /[+-]=-?[.\d]+/, Zn = /[^,'"\[\]\s]+/gi, Qn = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, $n, er, tr, nr, rr = {}, ir = {}, ar, or = function(e) {
    return (ir = Rr(e, rr)) && $a
}, sr = function(e, t) {
    ...
    suppressEvents: !0
}, mr = {}, hr = [], gr = {}, _r, vr = {}, yr = {}, br = 30, xr = [], Sr = ``, Cr = function(e) {
    var t = e[0], n, r;
    if (Rn(t) || Fn(t) || (e = [e]),
    !(n = (t._gsap || {}).harness)) {
        for (r = xr.length; r-- && !xr[r].targetTest(t); )
            ;
        n = xr[r]
    }
    for (r = e.length; r--; )
        e[r] && (e[r]._gsap || (e[r]._gsap = new la(e[r],n))) || e.splice(r, 1);
    return e
}, wr = function(e) {
    return e._gsap || Cr(xi(e))[0]._gsap
}, Tr = function(e, t, n) {
    return (n = e[t]) && Fn(n) ? e[t]() : Ln(n) && e.getAttribute && e.getAttribute(t) || n
}, Er = function(e, t) {
    ...
    var e = hr.length, t = hr.slice(0), n, r;
    for (gr = {},
    hr.length = 0,
    n = 0; n < e; n++)
        r = t[n],
    ...
    hr.length && !Tn && jr(),
    e.render(t, n, r || !!(Tn && t < 0 && Mr(e))),
    hr.length && !Tn && jr()
}, Pr = function(e) {
    var t = parseFloat(e);
    return (t || t === 0) && (e + ``).match(Zn).length < 2 ? t : Pn(e) ? e.trim() : e
}, Fr = function(e) {
    return e
}, Ir = function(e, t) {
    for (var n in t)
    ...
    for (var r in n)
        r !== `__proto__` && r !== `constructor` && r !== `prototype` && (t[r] = Rn(n[r]) ? e(t[r] || (t[r] = {}), n[r]) : n[r]);
    return t
}, Br = function(e, t) {
    var n = {}, r;
    for (r in e)
    ...
    var t = e.parent || $n
      , n = e.keyframes ? Lr(Un(e.keyframes)) : Ir;
    if (zn(e.inherit))
        for (; t; )
            n(e, t.vars.defaults),
            t = t.parent || t._dp;
    ...
    return e._startAt && (Tn ? e._startAt.revert(fr) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, r))
}, Yr = function e(t) {
    return !t || t._ts && e(t.parent)
}, Xr = function(e) {
    return e._repeat ? Zr(e._tTime, e = e.duration() + e._rDelay) * e : 0
}, Zr = function(e, t) {
    var n = Math.floor(e = Or(e / t));
    return e && n === e ? n - 1 : n
}, Qr = function(e, t) {
    return (e - t._start) * t._ts + (t._ts >= 0 ? 0 : t._dirty ? t.totalDuration() : t._tDur)
}, $r = function(e) {
    return e._end = Or(e._start + (e._tDur / Math.abs(e._ts || e._rts || I) || 0))
}, ei = function(e, t) {
    var n = e._dp;
    return n && n.smoothChildTiming && e._ts && (e._start = Or(n._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)),
    $r(e),
    n._dirty || Kr(n, e)),
    e
}, ti = function(e, t) {
    var n;
    if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (n = Qr(e.rawTime(), t),
    (!t._dur || hi(0, t.totalDuration(), n) - t._tTime > I) && t.render(n, !0)),
    Kr(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
    ...
    return t.parent && Gr(t),
    t._start = Or((In(n) ? n : n || e !== $n ? fi(e, n, t) : e._time) + t._delay),
    t._end = Or(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)),
    Ur(e, t, `_first`, `_last`, e._sort ? `_start` : 0),
    oi(t) || (e._recent = t),
    r || ti(e, t),
    e._ts < 0 && ei(e, e._tTime),
    e
}, ri = function(e, t) {
    return (rr.ScrollTrigger || sr(`scrollTrigger`, t)) && rr.ScrollTrigger.create(t, e)
}, ii = function(e, t, n, r, i) {
    if (va(e, t, i),
    !e._initted)
        return 1;
    if (!n && e._pt && !Tn && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && _r !== Xi.frame)
        return hr.push(e),
        e._lazy = [i, r],
        1
}, ai = function e(t) {
    ...
    var i = e.ratio, a = t < 0 || !t && (!e._start && ai(e) && !(!e._initted && oi(e)) || (e._ts < 0 || e._dp._ts < 0) && !oi(e)) ? 0 : 1, o = e._rDelay, s = 0, c, l, u;
    if (o && e._repeat && (s = hi(0, e._tDur, t),
    l = Zr(s, o),
    e._yoyo && l & 1 && (a = 1 - a),
    l !== Zr(e._tTime, o) && (i = 1 - a,
    e.vars.repeatRefresh && e._initted && e.invalidate())),
    a !== i || Tn || r || e._zTime === I || !t && e._zTime) {
        if (!e._initted && ii(e, t, r, n, s))
            return;
        for (u = e._zTime,
        e._zTime = t || (n ? I : 0),
        n ||= t && !u,
        ...
        s && e._repeat && !n && e.parent && Ii(e, `onRepeat`),
        (t >= e._tDur || t < 0) && e.ratio === a && (a && Gr(e, 1),
        !n && !Tn && (Ii(e, a ? `onComplete` : `onReverseComplete`, !0),
        e._prom && e._prom()))
    } else
        e._zTime ||= t
}, ci = function(e, t, n) {
    ...
    e._dur = a,
    e._tDur = i ? i < 0 ? 1e10 : Or(a * (i + 1) + e._rDelay * i) : a,
    o > 0 && !r && ei(e, e._tTime = e._tDur * o),
    e.parent && $r(e),
    n || Kr(e.parent, e),
    e
}, ui = function(e) {
    return e instanceof da ? Kr(e) : li(e, e._dur)
}, di = {
    _start: 0,
    endTime: ur,
    totalDuration: ur
}, fi = function e(t, n, r) {
    var i = t.labels, a = t._recent || di, o = t.duration() >= Dn ? a.endTime(!1) : t._dur, s, c, l;
    return Pn(n) && (isNaN(n) || n in i) ? (c = n.charAt(0),
    l = n.substr(-1) === `%`,
    s = n.indexOf(`=`),
    c === `<` || c === `>` ? (s >= 0 && (n = n.replace(/=/, ``)),
    ...
    l && r && (c = c / 100 * (Un(r) ? r[0] : r).totalDuration()),
    s > 1 ? e(t, n.substr(0, s - 1), r) + c : o + c)) : n == null ? o : +n
}, pi = function(e, t, n) {
    var r = In(t[1]), i = (r ? 2 : 1) + (e < 2 ? 0 : 1), a = t[i], o, s;
    if (r && (a.duration = t[1]),
    a.parent = n,
    e) {
        for (o = a,
        s = n; s && !(`immediateRender`in o); )
            o = s.vars.defaults || {},
            s = zn(s.vars.inherit) && s.parent;
        a.immediateRender = zn(o.immediateRender),
        e < 2 ? a.runBackwards = 1 : a.startAt = t[i - 1]
    }
    return new Ta(t[0],a,t[i + 1])
}, mi = function(e, t) {
    return e || e === 0 ? t(e) : t
}, hi = function(e, t, n) {
    return n < e ? e : n > t ? t : n
}, gi = function(e, t) {
    return !Pn(e) || !(t = Qn.exec(e)) ? `` : t[1]
}, _i = function(e, t, n) {
    return mi(n, function(n) {
        return hi(e, t, n)
    })
}, vi = [].slice, yi = function(e, t) {
    return e && Rn(e) && `length`in e && (!t && !e.length || e.length - 1 in e && Rn(e[0])) && !e.nodeType && e !== er
}, bi = function(e, t, n) {
    return n === void 0 && (n = []),
    e.forEach(function(e) {
        var r;
        return Pn(e) && !t || yi(e, 1) ? (r = n).push.apply(r, xi(e)) : n.push(e)
    }) || n
}, xi = function(e, t, n) {
    return En && !t && En.selector ? En.selector(e) : Pn(e) && !n && (tr || !Zi()) ? vi.call((t || nr).querySelectorAll(e), 0) : Un(e) ? bi(e, n) : yi(e) ? vi.call(e, 0) : e ? [e] : []
}, Si = function(e) {
    return e = xi(e)[0] || cr(`Invalid scope`) || {},
    function(t) {
        var n = e.current || e.nativeElement || e;
        return xi(t, n.querySelectorAll ? n : n === e ? cr(`Invalid scope`) || nr.createElement(`div`) : e)
    }
}, Ci = function(e) {
    ...
    function(e, o, d) {
        ...
        if (!p) {
            if (S = t.grid === `auto` ? 0 : (t.grid || [1, Dn])[1],
            !S) {
                for (b = -Dn; b < (b = d[S++].getBoundingClientRect().left) && S < f; )
                    ;
                S < f && S--
            }
            for (p = a[f] = [],
            m = s ? Math.min(S, f) * l - .5 : r % S,
            h = S === Dn ? 0 : s ? f * u / S - .5 : r / S | 0,
            b = 0,
            x = Dn,
            y = 0; y < f; y++)
                g = y % S - m,
                _ = h - (y / S | 0),
                p[y] = v = c ? Math.abs(c === `y` ? _ : g) : jn(g * g + _ * _),
                v > b && (b = v),
                v < x && (x = v);
            r === `random` && Ci(p),
            p.max = b - x,
            ...
            p.b = f < 0 ? i - f : i,
            p.u = gi(t.amount || t.each) || 0,
            n = n && f < 0 ? ra(n) : n
        }
        return f = (p[e] - p.min) / p.max || 0,
        Or(p.b + (n ? n(f) : f) * p.v) + p.u
    }
}, Ti = function(e) {
    var t = 10 ** ((e + ``).split(`.`)[1] || ``).length;
    return function(n) {
        var r = Or(Math.round(parseFloat(n) / e) * e * t);
        return (r - r % 1) / t + (In(n) ? 0 : gi(n))
    }
}, Ei = function(e, t) {
    var n = Un(e), r, i;
    return !n && Rn(e) && (r = n = e.radius || Dn,
    e.values ? (e = xi(e.values),
    (i = !In(e[0])) && (r *= r)) : e = Ti(e.increment)),
    mi(t, n ? Fn(e) ? function(t) {
        return i = e(t),
        Math.abs(i - t) <= r ? i : t
    }
    : function(t) {
        for (var n = parseFloat(i ? t.x : t), a = parseFloat(i ? t.y : 0), o = Dn, s = 0, c = e.length, l, u; c--; )
            i ? (l = e[c].x - n,
            u = e[c].y - a,
    ...
    return mi(Un(e) ? !t : n === !0 ? !!(n = 0) : !r, function() {
        return Un(e) ? e[~~(Math.random() * e.length)] : (n ||= 1e-5) && (r = n < 1 ? 10 ** ((n + ``).length - 2) : 1) && Math.floor(Math.round((e - n / 2 + Math.random() * (t - e + n * .99)) / n) * n * r) / r
    })
}, Oi = function() {
    var e = [...arguments];
    return function(t) {
    ...
    var i = n - t;
    return Un(t) ? ji(t, e(0, t.length), n) : mi(r, function(e) {
        return (i + (e - t) % i) % i + t
    })
}, Ni = function e(t, n, r) {
    var i = n - t
      , a = i * 2;
    return Un(t) ? ji(t, e(0, t.length - 1), n) : mi(r, function(e) {
    ...
    return e.replace(Wn, function(e) {
        var t = e.indexOf(`[`) + 1
          , n = e.substring(t || 7, t ? e.indexOf(`]`) : e.length - 1).split(Gn);
        return Di(t ? n : +n[0], t ? 0 : +n[1], +n[2] || 1e-5)
    })
}, Fi = function(e, t, n, r, i) {
    var a = t - e
      , o = r - n;
    return mi(i, function(t) {
        return n + ((t - e) / a * o || 0)
    })
    ...
    if (!a) {
        ...
        if (!u) {
            for (c in n)
                pa.call(s, t, c, `get`, n[c]);
            a = function(e) {
                return Pa(e, s) || (o ? t.p : t)
            }
        }
    }
    return mi(r, a)
}, R = function(e, t, n) {
    var r = e.labels, i = Dn, a, o, s;
    for (a in r)
        o = r[a] - t,
    ...
    var r = e.vars, i = r[t], a = En, o = e._ctx, s, c, l;
    if (i)
        return s = r[t + `Params`],
        c = r.callbackScope || e,
        n && hr.length && jr(),
    ...
    return Gr(e),
    e.scrollTrigger && e.scrollTrigger.kill(!!Tn),
        ...
        Bn() || e.headless) {
            ...
            e !== r) {
                if (vr[t])
                    return;
                Ir(r, Ir(Br(e, i), a)),
                Rr(r.prototype, Rr(i, Br(e, a))),
                vr[r.prop = t] = r,
                e.targetTest && (xr.push(r),
                mr[t] = 1),
                t = (t === `css` ? `CSS` : t.charAt(0).toUpperCase() + t.substr(1)) + `Plugin`
            }
            lr(t, r),
            e.register && e.register($a, r, za)
        } else
            zi.push(e)
}, z = 255, Vi = {
    aqua: [0, z, z],
    ...
    (e * 6 < 1 ? t + (n - t) * e * 6 : e < .5 ? n : e * 3 < 2 ? t + (n - t) * (2 / 3 - e) * 6 : t) * z + .5 | 0
}, Ui = function(e, t, n) {
    var r = e ? In(e) ? [e >> 16, e >> 8 & z, e & z] : 0 : Vi.black, i, a, o, s, c, l, u, d, f, p;
    if (!r) {
    ...
    var t = []
      , n = []
      , r = -1;
    return e.split(Ki).forEach(function(e) {
        var i = e.match(Jn) || [];
        t.push.apply(t, i),
        n.push(r += i.length + 1)
    }),
    ...
    var r = ``, i = (e + r).match(Ki), a = t ? `hsla(` : `rgba(`, o = 0, s, c, l, u;
    if (!i)
        return e;
    if (i = i.map(function(e) {
        return (e = Ui(e, t, 1)) && a + (t ? e[0] + `,` + e[1] + `%,` + e[2] + `%,` + e[3] : e.join(`,`)) + `)`
    }),
    n && (l = Wi(e),
    s = n.c,
    s.join(r) !== l.c.join(r)))
        for (c = e.replace(Ki, `1`).split(Jn),
        u = c.length - 1; o < u; o++)
    ...
    return d = {
        ...
        wake: function() {
            ar && (!tr && Bn() && (er = tr = window,
            nr = er.document || {},
            rr.gsap = $a,
            (er.gsapVersions ||= []).push($a.version),
            or(ir || er.GreenSockGlobals || !er.gsap && er || {}),
            zi.forEach(Bi)),
    ...
    var t = (e + ``).split(`(`)
      , n = B[t[0]];
    return n && t.length > 1 && n.config ? n.config.apply(null, ~e.indexOf(`{`) ? [ea(t[1])] : ta(e).split(`,`).map(Pr)) : B._CE && Qi.test(e) ? B._CE(``, e) : n
}, ra = function(e) {
    return function(t) {
        return 1 - e(1 - t)
    }
}, ia = function(e, t) {
    return e && (Fn(e) ? e : B[e] || na(e)) || t
}, aa = function(e, t, n, r) {
    ...
    return Er(e, function(e) {
        for (var t in B[e] = rr[e] = i,
        B[a = e.toLowerCase()] = n,
        i)
            B[a + (t === `easeIn` ? `.in` : t === `easeOut` ? `.out` : `.inOut`)] = B[e + `.` + t] = i[t]
    }),
    i
}, oa = function(e) {
    return function(t) {
    ...
    var i = n >= 1 ? n : 1
      , a = (r || (t ? .3 : .45)) / (n < 1 ? n : 1)
      , o = a / On * (Math.asin(1 / i) || 0)
      , s = function(e) {
        return e === 1 ? 1 : i * 2 ** (-10 * e) * Nn((e - o) * a) + 1
    }
...
aa(`Sine`, function(e) {
    return e === 1 ? 1 : -Mn(e * kn) + 1
}),
aa(`Back`, ca(`in`), ca(`out`), ca()),
B.SteppedEase = B.steps = rr.SteppedEase = {
    config: function(e, t) {
        e === void 0 && (e = 1);
        var n = 1 / e
          , r = e + +!t
...
var la = function(e, t) {
  ...
  , ua = function() {
    ...
    t.totalDuration = function(e) {
        ...
        li(this, this._repeat < 0 ? e : (e - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur
    }
    ,
    t.totalTime = function(e, t) {
        ...
        if (n && n.smoothChildTiming && this._ts) {
            for (ei(this, e),
            !n._dp || n.parent || ti(n, this); n && n.parent; )
        ...
        return (this._tTime !== e || !this._dur && !t || this._initted && Math.abs(this._zTime) === I || !this._initted && this._dur && e || !e && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = e),
        Nr(this, e, t)),
        this
    }
    ,
    t.time = function(e, t) {
        return arguments.length ? this.totalTime(Math.min(this.totalDuration(), e + Xr(this)) % (this._dur + this._rDelay) || (e ? this._dur : 0), t) : this._time
    }
    ,
    ...
    t.progress = function(e, t) {
        return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - e : e) + Xr(this), t) : this.duration() ? Math.min(1, this._time / this._dur) : +(this.rawTime() > 0)
    }
    ,
    t.iteration = function(e, t) {
        var n = this.duration() + this._rDelay;
        return arguments.length ? this.totalTime(this._time + (e - 1) * n, t) : this._repeat ? Zr(this._tTime, n) + 1 : 1
    }
    ,
    t.timeScale = function(e, t) {
        ...
        if (this._rts === e)
            return this;
        var n = this.parent && this._ts ? Qr(this.parent._time, this) : this._tTime;
        return this._rts = +e || 0,
        this._ts = this._ps || e === -I ? 0 : this._rts,
        this.totalTime(hi(-Math.abs(this._delay), this.totalDuration(), n), t !== !1),
        $r(this),
        qr(this)
    }
    ,
    t.paused = function(e) {
        ...
        this._ts = this._act = 0) : (Zi(),
        this._ts = this._rts,
        this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== I && (this._tTime -= I)))),
        this) : this._ps
    }
    ,
    t.startTime = function(e) {
        if (arguments.length) {
            ...
            return t && (t._sort || !this.parent) && ni(t, this, this._start - this._delay),
            this
        }
        return this._start
    }
    ...
    t.endTime = function(e) {
        return this._start + (zn(e) ? this.totalDuration() : this.duration()) / Math.abs(this._ts || 1)
    }
    ,
    t.rawTime = function(e) {
        var t = this.parent || this._dp;
        return t ? e && (!this._ts || this._repeat && this._time && this.totalProgress() < 1) ? this._tTime % (this._dur + this._rDelay) : this._ts ? Qr(t.rawTime(e), this) : this._tTime : this._tTime
    }
    ,
    t.revert = function(e) {
        e === void 0 && (e = pr);
        var t = Tn;
        return Tn = e,
        Mr(this) && (this.timeline && this.timeline.revert(e),
    ...
    t.repeat = function(e) {
        ...
        ui(this)) : this._repeat === -2 ? 1 / 0 : this._repeat
    }
    ,
    ...
    ,
    t.seek = function(e, t) {
        return this.totalTime(fi(this, e), zn(t))
    }
    ,
    t.restart = function(e, t) {
        return this.play().totalTime(e ? -this._delay : 0, zn(t)),
        this._dur || (this._zTime = -I),
        this
    }
    ,
    t.play = function(e, t) {
    ...
    t.reversed = function(e) {
        return arguments.length ? (!!e !== this.reversed() && this.timeScale(-this._rts || (e ? -I : 0)),
        this) : this._rts < 0
    }
    ,
        ...
        return new Promise(function(r) {
            var i = Fn(e) ? e : Fr
              , a = function() {
                ...
                t.then = null,
                n && n(),
                Fn(i) && (i = i(t)) && (i.then || i === t) && (t.then = e),
                r(i),
                t.then = e
            };
...
var da = function(e) {
    ...
    function t(t, n) {
        ...
        r._sort = zn(t.sortChildren),
        $n && ni(t.parent || $n, xn(r), n),
        t.reversed && r.reverse(),
        t.paused && r.paused(!0),
        t.scrollTrigger && ri(xn(r), t.scrollTrigger),
        r
    }
    var n = t.prototype;
    return n.to = function(e, t, n) {
        return pi(0, arguments, this),
        this
    }
    ,
    n.from = function(e, t, n) {
        return pi(1, arguments, this),
        this
    }
    ,
    n.fromTo = function(e, t, n, r) {
        return pi(2, arguments, this),
        this
    }
    ,
    n.set = function(e, t, n) {
        return t.duration = 0,
        t.parent = this,
        Vr(t).repeatDelay || (t.repeat = 0),
        t.immediateRender = !!t.immediateRender,
        new Ta(e,t,fi(this, n),1),
        this
    }
    ,
    n.call = function(e, t, n) {
        return ni(this, Ta.delayedCall(0, e, t), n)
    }
    ,
    n.staggerTo = function(e, t, n, r, i, a, o) {
        ...
        n.parent = this,
        new Ta(e,n,fi(this, i)),
        this
    }
    ,
    n.staggerFrom = function(e, t, n, r, i, a, o) {
        return n.runBackwards = 1,
        Vr(n).immediateRender = zn(n.immediateRender),
        this.staggerTo(e, t, n, r, i, a, o)
    }
    ,
    n.staggerFromTo = function(e, t, n, r, i, a, o, s) {
        return r.startAt = n,
        Vr(r).immediateRender = zn(r.immediateRender),
        this.staggerTo(e, t, r, i, a, o, s)
    }
    ,
    n.render = function(e, t, n) {
        var r = this._time, i = this._dirty ? this.totalDuration() : this._tDur, a = this._dur, o = e <= 0 ? 0 : Or(e), s = this._zTime < 0 != e < 0 && (this._initted || !a), c, l, u, d, f, p, m, h, g, _, v, y;
        if (this !== $n && o > i && e >= 0 && (o = i),
        o !== this._tTime || n || s) {
            ...
            this._repeat) {
                ...
                d !== _ && !this._lock) {
                    ...
                    r = b ? 0 : o % a ? a : o,
                    this._lock = 1,
                    this.render(r || (y ? 0 : Or(d * f)), t, !a)._lock = 0,
                    this._tTime = o,
                    !t && this.parent && Ii(this, `onRepeat`),
            ...
            if (this._hasPause && !this._forcing && this._lock < 2 && (m = ci(this, Or(r), Or(c)),
            m && (o -= c - (c = m._start))),
            this._tTime = o,
            this._time = c,
            this._act = !!h,
            ...
            if (c >= r && e >= 0)
                ...
                for (var S = e < 0 ? e : c; l; ) {
                    ...
                    (l._act || S <= l._end) && l._ts && m !== l) {
                        if (l.parent !== this)
                            return this.render(e, t, n);
                        if (l.render(l._ts > 0 ? (S - l._start) * l._ts : (l._dirty ? l.totalDuration() : l._tDur) + (S - l._start) * l._ts, t, n || Tn && Mr(l)),
                        c !== this._time || !this._ts && !p) {
                            m = 0,
                            u && (o += this._zTime = S ? -I : I);
                            break
                        }
                    }
                    l = u
            ...
            if (m && !t && (this.pause(),
            m.render(c >= r ? 0 : -I)._zTime = c >= r ? 1 : -1,
            this._ts))
                return this._start = g,
                $r(this),
                this.render(e, t, n);
            this._onUpdate && !t && Ii(this, `onUpdate`, !0),
            (o === i && this._tTime >= this.totalDuration() || !o && r) && (g === this._start || Math.abs(h) !== Math.abs(this._ts)) && (this._lock || ((e || !a) && (o === i && this._ts > 0 || !o && this._ts < 0) && Gr(this, 1),
            !t && !(e < 0 && !r) && (o || r || !i) && (Ii(this, o === i && e >= 0 ? `onComplete` : `onReverseComplete`, !0),
    ...
    n.add = function(e, t) {
        ...
        !(e instanceof ua)) {
            ...
            if (Fn(e))
                e = Ta.delayedCall(0, e);
            else
                return this
        }
        return this === e ? this : ni(this, e, t)
    }
    ,
    n.getChildren = function(e, t, n, r) {
        ...
        for (var i = [], a = this._first; a; )
            a._start >= r && (a instanceof Ta ? t && i.push(a) : (n && i.push(a),
    ...
    ,
    n.remove = function(e) {
        return Pn(e) ? this.removeLabel(e) : Fn(e) ? this.killTweensOf(e) : (e.parent === this && Wr(this, e),
    ...
    n.totalTime = function(t, n) {
        ...
        !this._dp && this._ts && (this._start = Or(Xi.time - (this._ts > 0 ? t / this._ts : (this.totalDuration() - t) / -this._ts))),
    ...
    n.addLabel = function(e, t) {
        return this.labels[e] = fi(this, t),
        this
    }
    ,
    ...
    n.removePause = function(e) {
        var t = this._first;
        for (e = fi(this, e); t; )
            t._start === e && t.data === `isPause` && Gr(t),
            t = t._next
    }
    ,
    ...
    n.getTweensOf = function(e, t) {
        for (var n = [], r = xi(e), i = this._first, a = In(t), o; i; )
            i instanceof Ta ? Ar(i._targets, r) && (a ? (!ga || i._initted && i._ts) && i.globalTime(0) <= t && i.globalTime(i.totalDuration()) > t : !t || i.isActive()) && n.push(i) : (o = i.getTweensOf(r, t)).length && n.push.apply(n, o),
            i = i._next;
        return n
    }
    ,
    n.tweenTo = function(e, t) {
        t ||= {};
        var n = this, r = fi(n, e), i = t, a = i.startAt, o = i.onStart, s = i.onStartParams, c = i.immediateRender, l, u = Ta.to(n, Ir({
            ease: t.ease || `none`,
            lazy: !1,
            immediateRender: !1,
            time: r,
            ...
            onStart: function() {
                ...
                !l) {
                    ...
                    u._dur !== e && li(u, e, 0, 1).render(u._time, !0, !0),
                    l = 1
                }
                o && o.apply(u, s || [])
            }
    ...
    n.totalDuration = function(e) {
        var t = 0, n = this, r = n._last, i = Dn, a, o, s;
        if (arguments.length)
        ...
        if (n._dirty) {
            for (s = n.parent; r; )
                ...
                ni(n, r, o - r._delay, 1)._lock = 0) : i = o,
                o < 0 && r._ts && (t -= o,
                (!s && !n._dp || s && s.smoothChildTiming) && (n._start += Or(o / n._ts),
                n._time -= o,
                n._tTime -= o),
                ...
                r = a;
            li(n, n === $n && n._time > t ? n._time : t, 1, 1),
            n._dirty = 0
        }
        return n._tDur
    }
    ...
    t.updateRoot = function(e) {
        if ($n._ts && (Nr($n, Qr(e, $n)),
        _r = Xi.frame),
        Xi.frame >= br) {
            br += F.autoSleep || 120;
            var t = $n._first;
            if ((!t || !t._ts) && F.autoSleep && Xi._listeners.length < 2) {
                for (; t && !t._ts; )
                    t = t._next;
                t || Xi.sleep()
            }
...
var fa = function(e, t, n, r, i, a, o) {
    var s = new za(this._pt,e,t,0,1,Na,null,i), c = 0, l = 0, u, d, f, p, m, h, g, _;
    for (s.b = n,
    s.e = r,
    n += ``,
    r += ``,
    (g = ~r.indexOf(`random(`)) && (r = Pi(r)),
    a && (_ = [n, r],
    a(_, e, t),
    n = _[0],
    r = _[1]),
    d = n.match(Yn) || []; u = Yn.exec(r); )
        p = u[0],
        ...
        s._pt = {
            ...
            p: m || l === 1 ? m : `,`,
            s: h,
            c: p.charAt(1) === `=` ? kr(h, p) - h : parseFloat(p) - h,
    ...
    this._pt = s,
    s
}, pa = function(e, t, n, r, i, a, o, s, c, l) {
    Fn(r) && (r = r(i || 0, e, a));
    var u = e[t], d = n === `get` ? Fn(u) ? c ? e[t.indexOf(`set`) || !Fn(e[`get` + t.substr(3)]) ? t : `get` + t.substr(3)](c) : e[t]() : u : n, f = Fn(u) ? c ? Oa : Da : Ea, p;
    if (Pn(r) && (~r.indexOf(`random(`) && (r = Pi(r)),
    r.charAt(1) === `=` && (p = kr(d, r) + (gi(d) || 0),
    (p || p === 0) && (r = p))),
    !l || d !== r || _a)
        return !isNaN(d * r) && r !== `` ? (p = new za(this._pt,e,t,+d || 0,r - (d || 0),typeof u == `boolean` ? Ma : ja,0,f),
        c && (p.fp = c),
        o && p.modifier(o, this, e),
        this._pt = p) : (!u && !(t in e) && sr(t, r),
        fa.call(this, e, t, d, r, f, s || F.stringFilter, c))
}, ma = function(e, t, n, r, i) {
    if (Fn(e) && (e = Sa(e, i, t, n, r)),
    !Rn(e) || e.style && e.nodeType || Un(e) || Hn(e))
        return Pn(e) ? Sa(e, i, t, n, r) : e;
    var a = {}, o;
    for (o in e)
        a[o] = Sa(e[o], i, t, n, r);
    return a
}, ha = function(e, t, n, r, i, a) {
    var o, s, c, l;
    if (vr[e] && (o = new vr[e]).init(i, o.rawVars ? t[e] : ma(t[e], r, i, a, n), n, r, a) !== !1 && (n._pt = s = new za(n._pt,i,e,0,1,o.render,o,0,o.priority),
    n !== Ri))
        for (c = n._ptLookup[n._targets.indexOf(i)],
        l = o._props.length; l--; )
            c[o._props[l]] = s;
    return o
}, ga, _a, va = function e(t, n, r) {
    var i = t.vars, a = i.ease, o = i.startAt, s = i.immediateRender, c = i.lazy, l = i.onUpdate, u = i.runBackwards, d = i.yoyoEase, f = i.keyframes, p = i.autoRevert, m = t._dur, h = t._startAt, g = t._targets, _ = t.parent, v = _ && _.data === `nested` ? _.vars.targets : g, y = t._overwrite === `auto` && !wn, b = t.timeline, x = i.easeReverse || d, S, C, w, T, E, D, O, k, A, j, ee, te, ne;
    if (b && (!f || !a) && (a = `none`),
    t._ease = ia(a, Cn.ease),
    t._rEase = x && (ia(x) || t._ease),
    t._from = !b && !!i.runBackwards,
    t._from && (t.ratio = 1),
    !b || f && !i.stagger) {
        if (k = g[0] ? wr(g[0]).harness : 0,
        te = k && i[k.prop],
        S = Br(i, mr),
        h && (h._zTime < 0 && h.progress(1),
        n < 0 && u && s && !p ? h.render(-1, !0) : h.revert(u && m ? fr : dr),
        h._lazy = 0),
        o) {
            if (Gr(t._startAt = Ta.set(g, Ir({
                data: `isStart`,
                overwrite: !1,
                parent: _,
                immediateRender: !0,
            ...
            t._startAt._dp = 0,
            t._startAt._sat = t,
            n < 0 && (Tn || !s && !p) && t._startAt.revert(fr),
            s && m && n <= 0 && r <= 0) {
                n && (t._zTime = n);
                return
            }
            ...
            te && (w[k.prop] = te),
            Gr(t._startAt = Ta.set(g, w)),
            t._startAt._dp = 0,
            t._startAt._sat = t,
            n < 0 && (Tn ? t._startAt.revert(fr) : t._startAt.render(-1, !0)),
            t._zTime = n,
            !s)
                e(t._startAt, I, I);
            else if (!n)
        ...
        C = 0; C < g.length; C++) {
            if (E = g[C],
            O = E._gsap || Cr(g)[C]._gsap,
            t._ptLookup[C] = j = {},
            gr[O.id] && hr.length && jr(),
            ee = v === g ? C : v.indexOf(E),
            k && (A = new k).init(E, te || S, t, ee, v) !== !1 && (t._pt = T = new za(t._pt,E,A.name,0,1,A.render,A,0,A.priority),
            ...
            !k || te)
                for (w in S)
                    vr[w] && (A = ha(w, S, t, ee, E, v)) ? A.priority && (D = 1) : j[w] = T = pa.call(t, E, w, `get`, S[w], ee, v, 0, i.stringFilter);
            t._op && t._op[C] && t.kill(E, t._op[C]),
            y && t._pt && (ga = t,
            $n.killTweensOf(E, j, t.globalTime(n)),
            ne = !t.parent,
            ga = 0),
            t._pt && c && (gr[O.id] = 1)
        }
    ...
    f && n <= 0 && b.render(Dn, !0, !0)
}, ya = function(e, t, n, r, i, a, o, s) {
    ...
    if (!c)
        ...
        f = e._targets.length; f--; ) {
            ...
            if (!l)
                ...
                va(e, o),
                _a = 0,
                s ? cr(t + ` not eligible for reset. Try splitting into individual properties`) : 1;
            c.push(l)
        }
    for (f = c.length; f--; )
        u = c[f],
    ...
    var n = e[0] ? wr(e[0]).harness : 0, r = n && n.aliases, i, a, o, s;
    if (!r)
        return t;
    for (a in i = Rr({}, t),
    r)
    ...
    return Fn(e) ? e.call(t, n, r, i) : Pn(e) && ~e.indexOf(`random(`) ? Pi(e) : e
}, Ca = Sr + `repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert`, wa = {};
Er(Ca + `,id,stagger,delay,duration,paused,scrollTrigger`, function(e) {
    return wa[e] = 1
});
var Ta = function(e) {
    Sn(t, e);
    function t(t, n, r, i) {
        ...
        n = r,
        r = null),
        a = e.call(this, i ? n : Vr(n)) || this;
        var o = a.vars, s = o.duration, c = o.delay, l = o.immediateRender, u = o.stagger, d = o.overwrite, f = o.keyframes, p = o.defaults, m = o.scrollTrigger, h = n.parent || $n, g = (Un(t) || Hn(t) ? In(t[0]) : `length`in n) ? [t] : xi(t), _, v, y, b, x, S, C, w;
        if (a._targets = g.length ? Cr(g) : cr(`GSAP target ` + t + ` not found. https://gsap.com`, !F.nullTargetWarn) || [],
        a._ptLookup = [],
        a._overwrite = d,
        f || u || Vn(s) || Vn(c)) {
            n = a.vars;
            var T = n.easeReverse || n.yoyoEase;
            if (_ = a.timeline = new da({
                data: `nested`,
                defaults: p || {},
            ...
            u || Vn(s) || Vn(c)) {
                ...
                for (v = 0; v < b; v++)
                    ...
                    w && Rr(y, w),
                    S = g[v],
                    y.duration = +Sa(s, xn(a), v, S, g),
                    y.delay = (+Sa(c, xn(a), v, S, g) || 0) - a._delay,
                ...
                Vr(Ir(_.vars.defaults, {
                    ease: `none`
                })),
                _._ease = ia(f.ease || n.ease || `none`);
                var E = 0, D, O, k;
                if (Un(f))
                    ...
                    for (x in y = {},
                    f)
                        x === `ease` || x === `easeEach` || xa(x, f[x], y, f.easeEach);
                    for (x in y)
            ...
            a.timeline = 0;
        return d === !0 && !wn && (ga = xn(a),
        $n.killTweensOf(g),
        ga = 0),
        ni(h, xn(a), r),
        n.reversed && a.reverse(),
        n.paused && a.paused(!0),
        (l || !s && !f && a._start === Or(h._time) && zn(l) && Yr(xn(a)) && h.data !== `nested`) && (a._tTime = -I,
    ...
    return n.render = function(e, t, n) {
        ...
        if (!a)
            ...
            this._repeat) {
                ...
                this.render(Or(d * u), !0).invalidate()._lock = 0)
            }
            if (!this._initted) {
                if (ii(this, o ? e : c, n, t, s))
            ...
            this._onUpdate && !t && (o && Jr(this, e, t, n),
            Ii(this, `onUpdate`)),
            this._repeat && u !== f && this.vars.onRepeat && !t && this.parent && Ii(this, `onRepeat`),
            (s === this._tDur || !s) && this._tTime === s && (o && !this._onUpdate && Jr(this, e, !0, !0),
            (e || !a) && (s === this._tDur && this._ts > 0 || !s && this._ts < 0) && Gr(this, 1),
            !t && !(o && !r) && (s || r || p) && (Ii(this, s === i ? `onComplete` : `onReverseComplete`, !0),
    ...
    n.resetTo = function(e, t, n, r, i) {
        ...
        return this._initted || va(this, a),
        o = this._ease(a / this._dur),
        ya(this, e, t, n, r, o, a, i) ? this.resetTo(e, t, n, r, 1) : (ei(this, 0),
        this.parent || Ur(this._dp, this, `_first`, `_last`, this._dp._sort ? `_start` : 0),
        this.render(0))
    }
    ,
    n.kill = function(e, t) {
        ...
        !e && (!t || t === `all`))
            ...
            this.parent ? Li(this) : this.scrollTrigger && this.scrollTrigger.kill(!!Tn),
            this;
        if (this.timeline) {
            var n = this.timeline.totalDuration();
            return this.timeline.killTweensOf(e, t, ga && ga.vars.overwrite !== !0)._first || Li(this),
            this.parent && n !== this.timeline.totalDuration() && li(this, this._dur * this.timeline._tDur / n, 0, 1),
            this
        }
        var r = this._targets, i = e ? xi(e) : r, a = this._ptLookup, o = this._pt, s, c, l, u, d, f, p;
        if ((!t || t === `all`) && Hr(r, i))
        ...
        p = r.length; p--; )
            if (~i.indexOf(r[p]))
                ...
                u)
                    f = c && c[d],
                    f && ((!(`kill`in f.d) || f.d.kill(d) === !0) && Wr(this, f, `_pt`),
                    delete c[d]),
                    l !== `all` && (l[d] = 1);
        return this._initted && !this._pt && o && Li(this),
        this
    }
    ,
    t.to = function(e, n) {
...
var Ea = function(e, t, n) {
  ...
  , Aa = function(e, t) {
    return Fn(e[t]) ? Da : Ln(e[t]) && e.setAttribute ? ka : Ea
}
  , ja = function(e, t) {
  ...
  , Ia = function(e) {
    for (var t = this._pt, n, r; t; )
        r = t._next,
        t.p === e && !t.op || t.op === e ? Wr(this, t, `_pt`) : t.dep || (n = 1),
        t = r;
    return !n
}
  , La = function(e, t, n, r) {
...
Er(Sr + `parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse`, function(e) {
    return mr[e] = 1
}),
rr.TweenMax = rr.TweenLite = Ta,
rr.TimelineLite = rr.TimelineMax = da,
$n = new da({
    sortChildren: !1,
    defaults: Cn,
...
var Ba = []
  ...
  , qa = function() {
    ...
    t.getTweens = function() {
        ...
        return this.data.forEach(function(n) {
            return n instanceof e ? t.push.apply(t, n.getTweens()) : n instanceof Ta && !(n.parent && n.parent.data === `nested`) && t.push(n)
        }),
        t
    }
    ,
    ...
    t.kill = function(e, t) {
        ...
        if (e ? (function() {
            ...
            r = n.data.length; r--; )
                i = n.data[r],
                i instanceof da ? i.data !== `nested` && (i.scrollTrigger && i.scrollTrigger.revert(),
                i.kill()) : !(i instanceof Ta) && i.revert && i.revert(e);
        ...
        this.clear(),
        t)
            for (var r = Ba.length; r--; )
                Ba[r].id === this.id && Ba.splice(r, 1)
    }
    ,
    t.revert = function(e) {
        this.kill(e || {})
  ...
  , Ja = function() {
    ...
    return t.add = function(e, t, n) {
        ...
        var r = new qa(0,n || this.scope), i = r.conditions = {}, a, o, s;
        for (o in En && !r.selector && (r.selector = En.selector),
        this.contexts.push(r),
        t = r.add(`onMatch`, t),
        r.queries = e,
        e)
            o === `all` ? s = 1 : (a = er.matchMedia(e[o]),
            a && (Ba.indexOf(r) < 0 && Ba.push(r),
            (i[o] = a.matches) && (s = 1),
            a.addListener ? a.addListener(Ka) : a.addEventListener(`change`, Ka)));
  ...
  , Ya = {
    ...
    getProperty: function(e, t, n, r) {
        ...
        var i = wr(e || {}).get
          , a = n ? Fr : Pr;
        return n === `native` && (n = ``),
        e && (t ? a((vr[t] && vr[t].get || i)(e, t, n, r)) : function(t, n, r) {
            return a((vr[t] && vr[t].get || i)(e, t, n, r))
        }
        )
    },
    ...
    defaults: function(e) {
        return e && e.ease && (e.ease = ia(e.ease, Cn.ease)),
        zr(Cn, e || {})
    },
    config: function(e) {
        return zr(F, e || {})
    ...
    registerEffect: function(e) {
        ...
        (r || ``).split(`,`).forEach(function(e) {
            return e && !vr[e] && !rr[e] && cr(t + ` effect requires ` + e + ` plugin.`)
        }),
        yr[t] = function(e, t, r) {
            return n(xi(e), Ir(t || {}, i), r)
        }
        ,
        a && (da.prototype[t] = function(e, n, r) {
            return this.add(yr[t](e, Rn(n) ? n : (r = n) && {}, this), r)
        }
        )
    },
    ...
    parseEase: function(e, t) {
        return arguments.length ? ia(e, t) : B
    },
    getById: function(e) {
        return $n.getById(e)
    },
    exportRoot: function(e, t) {
        e === void 0 && (e = {});
        var n = new da(e), r, i;
        for (n.smoothChildTiming = zn(e.smoothChildTiming),
        $n.remove(n),
        n._dp = 0,
        n._time = n._tTime = $n._time,
        r = $n._first; r; )
            i = r._next,
            (t || !(!r._dur && r instanceof Ta && r.vars.onComplete === r._targets[0])) && ni(n, r, r._start - r._delay),
            r = i;
        return ni($n, n, 0),
        n
    },
    context: function(e, t) {
        return e ? new qa(e,t) : En
    },
...
var Xa = function(e, t) {
  ...
  , $a = Ya.registerPlugin({
    ...
    render: function(e, t) {
        for (var n = t._pt; n; )
            Tn ? n.set(n.t, n.p, n.b, n) : n.r(e, n.d),
            n = n._next
    }
}, {
    name: `endArray`,
...
}, Qa(`roundProps`, Ti), Qa(`modifiers`), Qa(`snap`, Ei)) || Ya;
Ta.version = da.version = $a.version = `3.15.0`,
ar = 1,
Bn() && Zi(),
B.Power0,
B.Power1,
...
B.Expo,
B.Circ;
var eo, to, no, ro, io, ao, oo, so = function() {
    return typeof window < `u`
}, co = {}, V = 180 / Math.PI, lo = Math.PI / 180, uo = Math.atan2, H = 1e8, U = /([A-Z])/g, fo = /(left|right|width|margin|padding|x)/i, po = /[\s,\(]\S/, mo = {
    ...
    a[t] = n,
    a.renderTransform(i, a)
}, W = `transform`, G = W + `Origin`, Oo = function e(t, n) {
    var r = this
      , i = this.target
      , a = i.style
      , o = i._gsap;
    if (t in co && a) {
        ...
        t !== `transform`)
            ...
            ~t.indexOf(`,`) ? t.split(`,`).forEach(function(e) {
                return r.tfm[e] = qo(i, e)
            }) : this.tfm[t] = o.x ? o[t] : qo(i, t),
            t === G && (this.tfm.zOrigin = o.zOrigin);
        else
            return mo.transform.split(`,`).forEach(function(t) {
                return e.call(r, t, n)
            });
    ...
    for (i = 0; i < e.length; i += 3)
        e[i + 1] ? e[i + 1] === 2 ? t[e[i]](e[i + 2]) : t[e[i]] = e[i + 2] : e[i + 2] ? n[e[i]] = e[i + 2] : n.removeProperty(e[i].substr(0, 2) === `--` ? e[i] : e[i].replace(U, `-$1`).toLowerCase());
    if (this.tfm) {
        for (a in this.tfm)
            r[a] = this.tfm[a];
        ...
        i = oo(),
        (!i || !i.isStart) && !n[W] && (ko(n),
        r.zOrigin && n[G] && (n[G] += ` ` + r.zOrigin + `px`,
        r.zOrigin = 0,
        r.renderTransform()),
        r.uncache = 1)
    }
    ...
    return e._gsap || $a.core.getCache(e),
    t && e.style && e.nodeType && t.split(`,`).forEach(function(e) {
        return n.save(e)
    }),
    n
}, Mo, No = function(e, t) {
    var n = to.createElementNS ? to.createElementNS((t || `http://www.w3.org/1999/xhtml`).replace(/^https/, `http`), e) : to.createElement(e);
    return n && n.style ? n : to.createElement(e)
}, Po = function e(t, n, r) {
    var i = getComputedStyle(t);
    return i[n] || i.getPropertyValue(n.replace(U, `-$1`).toLowerCase()) || i.getPropertyValue(n) || !r && e(t, Io(n) || n, 1) || ``
}, Fo = `O,Moz,ms,Ms,Webkit`.split(`,`), Io = function(e, t, n) {
    var r = (t || io).style
      , i = 5;
    if (e in r && !n)
        return e;
    for (e = e.charAt(0).toUpperCase() + e.substr(1); i-- && !(Fo[i] + e in r); )
        ;
    return i < 0 ? null : (i === 3 ? `ms` : i >= 0 ? Fo[i] : ``) + e
}, Lo = function() {
    so() && window.document && (eo = window,
    to = eo.document,
    no = to.documentElement,
    io = No(`div`) || {
        style: {}
    },
    No(`div`),
    ...
    var t = e.ownerSVGElement, n = No(`svg`, t && t.getAttribute(`xmlns`) || `http://www.w3.org/2000/svg`), r = e.cloneNode(!0), i;
    ...
    return t && (t.width || t.height) || n || (t = Ro(e)),
    t && !t.width && !t.x && !t.y ? {
        x: +zo(e, [`x`, `cx`, `x1`]) || 0,
        y: +zo(e, [`y`, `cy`, `y1`]) || 0,
        width: 0,
    ...
    if (t) {
        ...
        n.removeProperty(r === `--` ? t : t.replace(U, `-$1`).toLowerCase())) : n.removeAttribute(t)
    }
}, Uo = function(e, t, n, r, i, a) {
    var o = new za(e._pt,t,n,0,1,a ? xo : bo);
    return e._pt = o,
    o.b = r,
    o.e = i,
    e._props.push(n),
    ...
    var a = parseFloat(r) || 0, o = (r + ``).trim().substr((a + ``).length) || `px`, s = io.style, c = fo.test(n), l = t.tagName.toLowerCase() === `svg`, u = (l ? `client` : `offset`) + (c ? `Width` : `Height`), d = 100, f = i === `px`, p = i === `%`, m, h, g, _;
    if (i === o || !a || Wo[i] || Wo[o])
        return a;
    if (o !== `px` && !f && (a = e(t, n, r, `px`)),
    _ = t.getCTM && Vo(t),
    (p || o === `%`) && (co[n] || ~n.indexOf(`adius`)))
    ...
    (!h || h === to || !h.appendChild) && (h = to.body),
    g = h._gsap,
    g && p && g.width && c && g.time === Xi.time && !g.uncache)
        return Dr(a / g.width * d);
    if (p && (n === `height` || n === `width`)) {
        var v = t.style[n];
        t.style[n] = d + i,
        m = t[u],
        v ? t.style[n] = v : Ho(t, n)
    } else
        (p || o === `%`) && !Go[Po(h, `display`)] && (s.position = Po(t, `position`)),
    ...
    g.time = Xi.time,
    g.width = h[u]),
    Dr(f ? m * a / d : m && a ? d / m * a : 0)
}, qo = function(e, t, n, r) {
    var i;
    return ro || Lo(),
    t in mo && t !== `transform` && (t = mo[t],
    ~t.indexOf(`,`) && (t = t.split(`,`)[0])),
    co[t] && t !== `transform` ? (i = as(e, r),
    i = t === `transformOrigin` ? i.svg ? i.origin : os(Po(e, G)) + ` ` + i.zOrigin + `px` : i[t]) : (i = e.style[t],
    (!i || i === `auto` || r || ~(i + ``).indexOf(`calc(`)) && (i = Qo[t] && Qo[t](e, t, n) || Po(e, t) || Tr(e, t) || +(t === `opacity`))),
    n && !~(i + ``).trim().indexOf(` `) ? Ko(e, t, i, n) + n : i
}, Jo = function(e, t, n, r) {
    if (!n || n === `none`) {
        var i = Io(t, e, 1)
          , a = i && Po(e, i, 1);
        a && a !== n ? (t = i,
        n = a) : t === `borderColor` && (n = Po(e, `borderTopColor`))
    }
    var o = new za(this._pt,e.style,t,0,1,Na), s = 0, c = 0, l, u, d, f, p, m, h, g, _, v, y, b;
    if (o.b = n,
    o.e = r,
    n += ``,
    r += ``,
    r.substring(0, 6) === `var(--` && (r = Po(e, r.substring(4, r.indexOf(`)`)))),
    r === `auto` && (m = e.style[t],
    e.style[t] = r,
    r = Po(e, t) || r,
    m ? e.style[t] = m : Ho(e, t)),
    l = [n, r],
    Ji(l),
    n = l[0],
    r = l[1],
    ...
    b.length) {
        for (; u = Jn.exec(r); )
            ...
            y = m.substr((f + ``).length),
            h.charAt(1) === `=` && (h = kr(f, h) + y),
            g = parseFloat(h),
            v = h.substr((g + ``).length),
            s = Jn.lastIndex - v.length,
            v || (v = v || F.units[t] || y,
            s === r.length && (r += v,
            o.e += v)),
            y !== v && (f = Ko(e, t, m, v) || 0),
        ...
        o.r = t === `display` && r === `none` ? xo : bo;
    return Xn.test(r) && (o.e = 0),
    this._pt = o,
    o
}, Yo = {
    top: `0%`,
    ...
    clearProps: function(e, t, n, r, i) {
        if (i.data !== `isFromStart`) {
            var a = e._pt = new za(e._pt,t,n,0,0,Zo);
            return a.u = r,
            a.pr = -10,
            a.tween = i,
            e._props.push(n),
...
}, $o = [1, 0, 0, 1, 0, 0], es = {}, ts = function(e) {
    return e === `matrix(1, 0, 0, 1, 0, 0)` || e === `none` || !e
}, ns = function(e) {
    var t = Po(e, W);
    return ts(t) ? $o : t.substr(7).match(qn).map(Dr)
}, rs = function(e, t) {
    var n = e._gsap || wr(e), r = e.style, i = ns(e), a, o, s, c;
    return n.svg && e.getAttribute(`transform`) ? (s = e.transform.baseVal.consolidate().matrix,
    i = [s.a, s.b, s.c, s.d, s.e, s.f],
    i.join(`,`) === `1,0,0,1,0,0` ? $o : i) : (i === $o && !e.offsetParent && e !== no && !n.svg && (s = r.display,
    r.display = `block`,
    a = e.parentNode,
    ...
    no.appendChild(e)),
    i = ns(e),
    s ? r.display = s : Ho(e, `display`),
    c && (o ? a.insertBefore(e, o) : a ? a.appendChild(e) : no.removeChild(e))),
    t && i.length > 6 ? [i[0], i[1], i[4], i[5], i[12], i[13]] : i)
}, is = function(e, t, n, r, i, a) {
    var o = e._gsap, s = i || rs(e, !0), c = o.xOrigin || 0, l = o.yOrigin || 0, u = o.xOffset || 0, d = o.yOffset || 0, f = s[0], p = s[1], m = s[2], h = s[3], g = s[4], _ = s[5], v = t.split(` `), y = parseFloat(v[0]) || 0, b = parseFloat(v[1]) || 0, x, S, C, w;
    n ? s !== $o && (S = f * h - p * m) && (C = h / S * y + b * (-m / S) + (m * _ - h * g) / S,
    ...
    e.style[G] = `0px 0px`,
    a && (Uo(a, o, `xOrigin`, c, y),
    Uo(a, o, `yOrigin`, l, b),
    Uo(a, o, `xOffset`, u, o.xOffset),
    Uo(a, o, `yOffset`, d, o.yOffset)),
    e.setAttribute(`data-svg-origin`, y + ` ` + b)
}, as = function(e, t) {
    var n = e._gsap || new la(e);
    if (`x`in n && !t && !n.uncache)
        return n;
    var r = e.style, i = n.scaleX < 0, a = `px`, o = `deg`, s = getComputedStyle(e), c = Po(e, G) || `0`, l = u = d = m = h = g = _ = v = y = 0, u, d, f = p = 1, p, m, h, g, _, v, y, b, x, S, C, w, T, E, D, O, k, A, j, ee, te, ne, re, M, N, ie, ae, oe;
    return n.svg = !!(e.getCTM && Vo(e)),
    s.translate && ((s.translate !== `none` || s.scale !== `none` || s.rotate !== `none`) && (r[W] = (s.translate === `none` ? `` : `translate3d(` + (s.translate + ` 0 0`).split(` `).slice(0, 3).join(`, `) + `) `) + (s.rotate === `none` ? `` : `rotate(` + s.rotate + `) `) + (s.scale === `none` ? `` : `scale(` + s.scale.split(` `).join(`,`) + `) `) + (s[W] === `none` ? `` : s[W])),
    r.scale = r.rotate = r.translate = `none`),
    S = rs(e, n.svg),
    n.svg && (n.uncache ? (te = e.getBBox(),
    c = n.xOrigin - te.x + `px ` + (n.yOrigin - te.y) + `px`,
    ee = ``) : ee = !t && e.getAttribute(`data-svg-origin`),
    is(e, ee || c, !!ee || n.originIsAbsolute, n.smooth !== !1, S)),
    b = n.xOrigin || 0,
    x = n.yOrigin || 0,
    S !== $o && (E = S[0],
    D = S[1],
    ...
    g = 180 - g),
    f = Dr(Math.sqrt(E * E + D * D + O * O)),
    p = Dr(Math.sqrt(j * j + oe * oe)),
    C = uo(A, j),
    _ = Math.abs(C) > 2e-4 ? C * V : 0,
    y = ae ? 1 / (ae < 0 ? -ae : ae) : 0),
    n.svg && (ee = e.getAttribute(`transform`),
    n.forceCSS = e.setAttribute(`transform`, ``) || !ts(Po(e, W)),
    ...
    (n.zOrigin = parseFloat(c.split(` `)[2]) || !t && n.zOrigin || 0) && (r[G] = os(c)),
    n.xOffset = n.yOffset = 0,
    n.force3D = F.force3D,
    n.renderTransform = n.svg ? ps : Mo ? fs : cs,
    n.uncache = 0,
    n
}, os = function(e) {
    ...
    var r = gi(t);
    return Dr(parseFloat(t) + parseFloat(Ko(e, `x`, n + `px`, r))) + r
}, cs = function(e, t) {
    t.z = `0px`,
    t.rotationY = t.rotationX = `0deg`,
    t.force3D = 0,
    fs(e, t)
}, ls = `0deg`, us = `0px`, ds = `) `, fs = function(e, t) {
    var n = t || this
      , r = n.xPercent
      , i = n.yPercent
      , a = n.x
      ...
      , b = g === `auto` && e && e !== 1 || g === !0;
    if (v && (u !== ls || l !== ls)) {
        var x = parseFloat(l) * lo, S = Math.sin(x), C = Math.cos(x), w;
        x = parseFloat(u) * lo,
        w = Math.cos(x),
        a = ss(_, a, S * w * -v),
        o = ss(_, o, -Math.sin(x) * -v),
        s = ss(_, s, C * w * -v + v)
    }
    h !== us && (y += `perspective(` + h + ds),
    (r || i) && (y += `translate(` + r + `%, ` + i + `%) `),
    (b || a !== us || o !== us || s !== us) && (y += s !== us || b ? `translate3d(` + a + `, ` + o + `, ` + s + `) ` : `translate(` + a + `, ` + o + ds),
    c !== ls && (y += `rotate(` + c + ds),
    l !== ls && (y += `rotateY(` + l + ds),
    u !== ls && (y += `rotateX(` + u + ds),
    (d !== ls || f !== ls) && (y += `skew(` + d + `, ` + f + ds),
    (p !== 1 || m !== 1) && (y += `scale(` + p + `, ` + m + ds),
    _.style[W] = y || `translate(0, 0)`
}, ps = function(e, t) {
    ...
    C = d,
    x = S = 0),
    (v && !~(a + ``).indexOf(`px`) || y && !~(o + ``).indexOf(`px`)) && (v = Ko(f, `x`, a, `px`),
    y = Ko(f, `y`, o, `px`)),
    (p || m || h || g) && (v = Dr(v + p - (p * b + m * S) + h),
    y = Dr(y + m - (p * x + m * C) + g)),
    (r || i) && (w = f.getBBox(),
    v = Dr(v + r / 100 * w.width),
    y = Dr(y + i / 100 * w.height)),
    w = `matrix(` + b + `,` + x + `,` + S + `,` + C + `,` + v + `,` + y + `)`,
    f.setAttribute(`transform`, w),
    _ && (f.style[W] = w)
}, ms = function(e, t, n, r, i) {
    var a = 360, o = Pn(i), s = parseFloat(i) * (o && ~i.indexOf(`rad`) ? V : 1) - r, c = r + s + `deg`, l, u;
    return o && (l = i.split(`_`)[1],
    l === `short` && (s %= a,
    s !== s % (a / 2) && (s += s < 0 ? a : -a)),
    l === `cw` && s < 0 ? s = (s + a * H) % a - ~~(s / a) * a : l === `ccw` && s > 0 && (s = (s - a * H) % a - ~~(s / a) * a)),
    e._pt = u = new za(e._pt,t,n,r,s,go),
    u.e = c,
    u.u = `deg`,
    e._props.push(n),
    u
    ...
    var r = hs({}, n._gsap), i = `perspective,force3D,transformOrigin,svgOrigin`, a = n.style, o, s, c, l, u, d, f, p;
    for (s in r.svg ? (c = n.getAttribute(`transform`),
    n.setAttribute(`transform`, ``),
    a[W] = t,
    o = as(n, 1),
    Ho(n, W),
    n.setAttribute(`transform`, c)) : (c = getComputedStyle(n)[W],
    a[W] = t,
    o = as(n, 1),
    a[W] = c),
    co)
        c = r[s],
        l = o[s],
        c !== l && i.indexOf(s) < 0 && (f = gi(c),
        p = gi(l),
        u = f === p ? parseFloat(c) : Ko(n, s, c, p),
        d = parseFloat(l),
        e._pt = new za(e._pt,o,s,u,d - u,ho),
        e._pt.u = p || 0,
        e._props.push(s));
    hs(o, r)
};
Er(`padding,margin,Width,Radius`, function(e, t) {
    ...
    Qo[t > 1 ? `border` + e : e] = function(e, t, n, r, i) {
        var a, s;
...
var _s = {
    ...
    init: function(e, t, n, r, i) {
        ...
        t)
            ...
            !(vr[m] && ha(m, t, n, r, e, i)))) {
                ...
                f = typeof l),
                f === `string` && ~l.indexOf(`random(`) && (l = Pi(l)),
                p)
                    p(this, e, m, l, n) && (S = 1);
                    ...
                    Ki.test(c) || (h = gi(c),
                    g = gi(l),
                    g ? h !== g && (c = Ko(e, m, c, g) + g) : h && (l += h)),
                    this.add(o, `setProperty`, c, l, r, i, 0, 0, m),
                    a.push(m),
                    C.push(m, 0, o[m]);
                else if (f !== `undefined`) {
                    if (s && m in s ? (c = typeof s[m] == `function` ? s[m].call(n, r, e, i) : s[m],
                    Pn(c) && ~c.indexOf(`random(`) && (c = Pi(c)),
                    gi(c + ``) || c === `auto` || (c += F.units[m] || gi(qo(e, m)) || ``),
                    (c + ``).charAt(1) === `=` && (c = qo(e, m))) : c = qo(e, m),
                    d = parseFloat(c),
                    _ = f === `string` && l.charAt(1) === `=` && l.substr(0, 2),
                    _ && (l = l.substr(2)),
                    u = parseFloat(l),
                    m in mo && (m === `autoAlpha` && (d === 1 && qo(e, `visibility`) === `hidden` && u && (d = 0),
                    C.push(`visibility`, 0, o.visibility),
                    Uo(this, o, `visibility`, d ? `inherit` : `hidden`, u ? `inherit` : `hidden`, !u)),
                    m !== `scale` && m !== `transform` && (m = mo[m],
                    ...
                    v) {
                        ...
                        f === `string` && l.substring(0, 6) === `var(--`) {
                            if (l = Po(e, l.substring(4, l.indexOf(`)`))),
                            l.substring(0, 5) === `calc(`) {
                                var T = e.style.perspective;
                                e.style.perspective = l,
                                l = Po(e, `perspective`),
                                T ? e.style.perspective = T : Ho(e, `perspective`)
                            }
                            u = parseFloat(l)
                        }
                        if (y || (b = e._gsap,
                        b.renderTransform && !t.parseTransform || as(e, t.parseTransform),
                        x = t.smoothOrigin !== !1 && b.smooth,
                        y = this._pt = new za(this._pt,o,W,0,1,b.renderTransform,b,0,-1),
                        y.dep = 1),
                        m === `scale`)
                            this._pt = new za(this._pt,b,`scaleY`,b.scaleY,(_ ? kr(b.scaleY, _ + u) : u) - b.scaleY || 0,ho),
                            this._pt.u = 0,
                            a.push(`scaleY`, m),
                            m += `X`;
                            ...
                            C.push(G, 0, o[G]),
                            l = Xo(l),
                            b.svg ? is(e, l, 0, x, 0, this) : (g = parseFloat(l.split(` `)[2]) || 0,
                            g !== b.zOrigin && Uo(this, b, `zOrigin`, b.zOrigin, g),
                            Uo(this, o, m, os(c), os(l)));
                            continue
                        } else if (m === `svgOrigin`) {
                            is(e, l, 1, x, 0, this);
                            continue
                        } else if (m in es) {
                            ms(this, b, m, d, _ ? kr(d, _ + l) : l);
                            continue
                        } else if (m === `smoothOrigin`) {
                            Uo(this, b, `smooth`, b.smooth, l);
                            continue
                        } else if (m === `force3D`) {
                            b[m] = l;
                            continue
                        ...
                        m in o || (m = Io(m) || m);
                    if (v || (u || u === 0) && (d || d === 0) && !po.test(l) && m in o)
                        h = (c + ``).substr((d + ``).length),
                        u ||= 0,
                        g = gi(l) || (m in F.units ? F.units[m] : h),
                        h !== g && (d = Ko(e, m, c, g)),
                        this._pt = new za(this._pt,v ? b : o,m,d,(_ ? kr(d, _ + u) : u) - d,!v && (g === `px` || m === `zIndex`) && t.autoRound !== !1 ? yo : ho),
                        this._pt.u = g || 0,
                        v && w !== l ? (this._pt.b = c,
                        this._pt.e = w,
                        this._pt.r = vo) : h !== g && g !== `%` && (this._pt.b = c,
                        this._pt.r = _o);
                    else if (m in o)
                        Jo.call(this, e, m, c, _ ? _ + l : l);
                    else if (m in e)
    ...
    getSetter: function(e, t, n) {
        ...
        t in co && t !== G && (e._gsap.x || qo(e, `x`)) ? n && ao === n ? t === `scale` ? To : wo : (ao = n || {}) && (t === `scale` ? Eo : Do) : e.style && !Ln(e.style[t]) ? So : ~t.indexOf(`-`) ? Co : Aa(e, t)
    },
    core: {
        _removeProperty: Ho,
        _getMatrix: rs
...
$a.utils.checkPrefix = Io,
$a.core.getStyleSaver = jo,
(function(e, t, n, r) {
    var i = Er(e + `,` + t + `,` + n, function(e) {
        co[e] = 1
    });
    Er(t, function(e) {
        F.units[e] = `deg`,
...
$a.registerPlugin(_s);
var vs = $a.registerPlugin(_s) || $a;
vs.core.Tween;
var ys = (0,
y.forwardRef)( ({customClass: e, ...t}, n) => (0,
x.jsx)(`div`, {
    ref: n,
    ...t,
    className: `card ${e ?? ``} ${t.className ?? ``}`.trim()
}));
ys.displayName = `Card`;
var bs = (e, t, n, r) => ({
    x: e * t,
  ...
  , Ss = ({width: e=500, height: t=400, cardDistance: n=60, verticalDistance: r=70, delay: i=5e3, pauseOnHover: a=!1, onCardClick: o, skewAmount: s=6, easing: c=`elastic`, children: l}) => {
    let u = c === `elastic` ? {
      ...
      , d = (0,
    y.useMemo)( () => y.Children.toArray(l), [l])
      , f = (0,
    y.useMemo)( () => d.map( () => y.createRef()), [d.length])
      , p = (0,
    y.useRef)(Array.from({
        length: d.length
    }, (e, t) => t))
    ...
    y.useEffect)( () => {
        let e = f.length;
        f.forEach( (t, i) => xs(t.current, bs(i, n, r, e), s));
        let t = () => {
            ...
            a.addLabel(`promote`, `-=${u.durDrop * u.promoteOverlap}`),
            t.forEach( (e, t) => {
                let i = f[e].current
                  , o = bs(t, n, r, f.length);
                a.set(i, {
            ...
            let o = bs(f.length - 1, n, r, f.length);
            a.addLabel(`return`, `promote+=${u.durMove * u.returnDelay}`),
            a.call( () => {
                vs.set(i, {
                    zIndex: o.zIndex
                })
        ...
        ;
        if (t(),
        h.current = window.setInterval(t, i),
        a) {
            let e = g.current
              , n = () => {
                m.current?.pause(),
            ...
            ;
            return e.addEventListener(`mouseenter`, n),
...
function Es({onNavigate: e}) {
    ...
    x.jsxs)(`section`, {
        ...
        x.jsx)(`div`, {
            ...
            x.jsxs)(`div`, {
                ...
                x.jsxs)(`div`, {
                    children: [(0,
                    x.jsx)(`h2`, {
                        children: `Welcome to JaJu Republics`
                    }), (0,
                    x.jsx)(`p`, {
                        className: `lead`,
                        children: `Discover a unique country in Asia with a rich culture, vibrant spirit, and democratic values.`
                    }), (0,
                    x.jsxs)(`p`, {
                        className: `tagline`,
                        children: [`National Motto: `, (0,
        ...
        x.jsxs)(`div`, {
            className: `nav-cards-container nav-cards-container--swap`,
            children: [(0,
            x.jsxs)(`div`, {
                className: `nav-swap-copy`,
                children: [(0,
                x.jsx)(`p`, {
                    className: `section-kicker`,
                    children: `Section Navigator`
                }), (0,
                x.jsx)(`h3`, {
                    className: `section-title`,
                    children: `Explore JaJu Republics`
                }), (0,
                x.jsx)(`p`, {
                    className: `nav-cards-copy`,
                    children: `Use the stacked cards to move through the story of JaJu Republics. Each card leads directly to its section.`
                })]
            }), (0,
            x.jsx)(`div`, {
                className: `nav-swap-stage`,
                children: (0,
                x.jsx)(Ss, {
                    width: 340,
                    height: 230,
                    ...
                    x.jsxs)(ys, {
                        ...
                        children: [(0,
                        x.jsxs)(`div`, {
                            className: `nav-swap-card__header`,
                            children: [(0,
                            x.jsx)(`span`, {
        ...
        x.jsxs)(`details`, {
            className: `quick-facts content-panel`,
            open: !0,
            children: [(0,
            x.jsx)(`summary`, {
                className: `content-panel__summary`,
            ...
            x.jsx)(`div`, {
                className: `quick-facts-grid content-panel__body`,
                children: Cs.map(e => (0,
                x.jsxs)(`div`, {
                    className: `fact-box`,
                    children: [(0,
        ...
        x.jsxs)(`details`, {
            className: `features-panel content-panel`,
            children: [(0,
            x.jsx)(`summary`, {
                className: `content-panel__summary`,
                children: (0,
                x.jsx)(`span`, {
                    children: `Why Visit JaJu?`
                })
            }), (0,
            x.jsx)(`div`, {
                className: `features content-panel__body`,
                children: Ts.map(e => (0,
                x.jsxs)(`article`, {
...
var Ds = [`home`, `about`, `geography`, `government`, `economy`];
function Os() {
    let e = window.location.hash.replace(`#`, ``);
    return Ds.includes(e) ? e : `home`
}
function ks() {
    let[e,t] = (0,
    y.useState)(Os)
    ...
    x.jsxs)(`div`, {
        ...
        x.jsxs)(`main`, {
            ...
            x.jsx)(tn, {}) : null, e === `geography` ? (0,
            x.jsx)(pn, {}) : null, e === `government` ? (0,
            x.jsx)(bn, {}) : null, e === `economy` ? (0,
            x.jsx)(ln, {}) : null]
        }), (0,
        x.jsx)(C, {
            activeSection: e,
...
b.createRoot(document.getElementById(`root`)).render((0,
x.jsx)(y.StrictMode, {
    children: (0,
    x.jsx)(ks, {})
}));
